...
START_OPTS="-jar ${LIGHTNINGAPP_HOME}/start.jar ${LIGHTNINGAPP_HOME}/etc/jetty.xml"

JAVA_OPTS=""
JAVA_OPTS="${JAVA_OPTS} -Dlightning.website.uri=http://localhost:${LIGHTNING_HTTPPORT}"
JAVA_OPTS="${JAVA_OPTS} -Dlightning.stopcommand.file=${LIGHTNINGAPP_HOME}/stop.sh"
