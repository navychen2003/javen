...
(function($) {
    ...
    File.prototype.makeThumb = function(options, optionObj) {
        var opts = {};
        ...
        //$self.change(function() {
            ...
            var imageH, imageW, targetH, targetW, tragetX, tragetY;
            var ratio;
            var callback = function(fEvt) {
                ...
                if ($.isFunction(opts.success)) {
                    ...
                    opts.success.apply(self, [dataURL, targetSize, file, imageSize, fEvt, optionObj]);
                }
            ...
            var drawImage = function(fEvt, exif) {
				...
				imageW = mpImg.srcImage.width;
				imageH = mpImg.srcImage.height;
