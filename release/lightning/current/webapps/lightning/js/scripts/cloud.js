  ...
  debug_element
    ...
    (
      ...
      function( event )
      {
        ...
        (
          {
            url : app.config.lightning_path + '/zookeeper?wt=json&dump=true&token=' + app_token(),
            dataType : 'text',
...
var prepare_graph = function( graph_element, callback )
{
  ...
  (
    {
      url : app.config.lightning_path + '/zookeeper?wt=json&path=%2Flive_nodes&token=' + app_token(),
      dataType : 'json',
      success : function( response, text_status, xhr )
      {
        var live_nodes = {};
        ...
        (
          {
            url : app.config.lightning_path + '/zookeeper?wt=json&detail=true&path=%2Fclusterstate.json&token=' + app_token(),
            dataType : 'json',
...
var init_tree = function( tree_element )
{
  ...
  (
    {
      url : app.config.lightning_path + '/zookeeper?wt=json&token=' + app_token(),
      dataType : 'json',
