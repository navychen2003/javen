...
(
  ...
  function( event, params )
  {
    ...
    (
      {
        url : app.config.lightning_path + app.config.core_admin_path + '?wt=json&token=' + app_token(),
        dataType : 'json',
                ...
                reload_button
                  ...
                  (
                    ...
                    function( event )
                    {
                      ...
                      (
                        {
                          url : app.config.lightning_path + app.config.core_admin_path + '?wt=json&token=' + app_token() + '&action=RELOAD&core=' + current_core,
                          dataType : 'json',
                          context : $( this ),
                          beforeSend : function( xhr, settings )
                          {
                ...
                $( '#actions #unload', cores_element )
                  ...
                  (
                    ...
                    function( event )
                    {
                      ...
                      (
                        {
                          url : app.config.lightning_path + app.config.core_admin_path + '?wt=json&action=UNLOAD&core=' + current_core + '&token=' + app_token(),
                          dataType : 'json',
                          context : $( this ),
                          beforeSend : function( xhr, settings )
                          {
