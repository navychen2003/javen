  ...
  function( context )
  {
    ...
    (
      ...
      function( template )
      {
        ...
        (
          {
            url : core_basepath + '/admin/luke?wt=json&show=schema&token=' + app_token(),
            dataType : 'json',
        ...
        analysis_form
          ...
          (
            ...
            function( event )
            {
              var url = core_basepath + '/analysis/field?wt=json&token=' + app_token() + '&analysis.showmatch=true&' + context.path.split( '?' ).pop();
