    ...
    (
      {
        ...
        success : function( template )
        {
          ...
          var data = {
            ...
            'lightning_spec_version' : app.dashboard_values['indexdb']['lightning-spec-version'] || '-',
            'lightning_impl_version' : app.dashboard_values['indexdb']['lightning-impl-version'] || '-',
            'indexdb_spec_version' : app.dashboard_values['indexdb']['indexdb-spec-version'] || '-',
            'indexdb_impl_version' : app.dashboard_values['indexdb']['indexdb-impl-version'] || '-'
          };
          ...
          $( '#system a.reload', this )
            ...
            (
              ...
              function( event )
              {
                ...
                (
                  {
                    url : environment_basepath + '/admin/system?wt=json&token=' + app_token(),
                    dataType : 'json',
                    context : this,
                    beforeSend : function( arr, form, options )
                    {
