  ...
  function( context )
  {
    ...
    (
      ...
      function( template )
      {
        ...
        (
          {
            url : core_basepath + '/admin/luke?wt=json&show=index&numTerms=0&token=' + app_token(),
            dataType : 'json',
              ...
              $( 'a', optimized_element )
                ...
                (
                  ...
                  {                        
                    ...
                    (
                      {
                      url : core_basepath + '/update?optimize=true&waitFlush=true&wt=json&token=' + app_token(),
                      dataType : 'json',
                      context : $( this ),
                      beforeSend : function( xhr, settings )
                      {
        ...
        (
          {
            url : core_basepath + '/replication?command=details&wt=json&token=' + app_token(),
            dataType : 'json',
        ...
        (
          {
            url : core_basepath + '/dataimport?command=details&wt=json&token=' + app_token(),
            dataType : 'json',
        ...
        (
          {
            url : core_basepath + '/admin/ping?action=status&wt=json&token=' + app_token(),
            dataType : 'json',
              ...
              $( '.healthcheck-status', status_element )
                ...
                (
                  ...
                  {                      
                    ...
                    (
                      {
                        url : core_basepath + '/admin/ping?action=' + action + '&wt=json&token=' + app_token(),
                        dataType : 'json',
                        context : $( this ),
                        beforeSend : function( xhr, settings )
                        {
