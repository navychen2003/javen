...
{
  var luke_url = core_basepath + '/admin/luke?wt=json&fl=' + field + '&token=' + app_token();
...
(
  ...
  function( event, params )
  {
    ...
    else
    {
      ...
      (
        {
          url : core_basepath + '/admin/luke?numTerms=0&wt=json&token=' + app_token(),
          dataType : 'json',
          beforeSend : function( xhr, settings )
          {
          },
          success : function( response, text_status, xhr )
          {
            ...
            (
            {
              url : core_basepath + '/admin/luke?show=schema&wt=json&token=' + app_token(),
              dataType : 'json',
              beforeSend : function( xhr, settings )
              {
              },
