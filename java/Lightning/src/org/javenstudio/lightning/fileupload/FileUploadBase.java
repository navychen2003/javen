...
import org.javenstudio.lightning.fileupload.MultipartStream.ItemInputStream;
import org.javenstudio.lightning.fileupload.servlet.ServletFileUpload;
import org.javenstudio.lightning.fileupload.servlet.ServletRequestContext;
import org.javenstudio.lightning.fileupload.util.Closeable;
import org.javenstudio.lightning.fileupload.util.FileItemHeadersImpl;
import org.javenstudio.lightning.fileupload.util.LimitedInputStream;
...
public abstract class FileUploadBase {
    ...
    public static final boolean isMultipartContent(RequestInput ctx) {
        String contentType = ctx.getContentType();
        if (contentType == null) {
            return false;
        }
            ...
            while (iter.hasNext()) {
                ...
                try {
                	if (LOG.isDebugEnabled())
                		LOG.debug("parseRequest: copy " + item + " to " + fileItem);
    ...
    private class FileItemIteratorImpl implements FileItemIterator {
        ...
        class FileItemStreamImpl implements FileItemStream {
            ...
            public String toString() { 
            	return getClass().getSimpleName() + "{fieldName=" + fieldName 
        ...
        FileItemIteratorImpl(RequestContext ctx)
            ...
            final long requestSize = UploadContext.class.isAssignableFrom(ctx.getClass())
                                     ...
                                     ? ((UploadContext) ctx).getUploadLength()
                                     : contentLengthInt;
                                     // CHECKSTYLE:ON
