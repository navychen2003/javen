...
public class HttpUtil {
  ...
  private static HttpConfigurer configurer = new HttpConfigurer();
  
  private HttpUtil(){}
  
  /**
   * Replace the {@link HttpConfigurer} class used in configuring the http
   * clients with a custom implementation.
   */
  public static void setConfigurer(HttpConfigurer newConfigurer) {
   ...
   */
  public static HttpClient createClient(final Params params) throws ErrorException {
    final ModifiableParams config = new ModifiableParams(params);
   ...
   * present in config.
   */
  public static void configureClient(final DefaultHttpClient httpClient, Params config) throws ErrorException {
