...
public class SearchContextLoader extends DOMContextLoader 
		implements ResourceLoader {
	private static final Logger LOG = Logger.getLogger(SearchContextLoader.class);
	...
	public SearchContextLoader(String instanceDir) { 
		this(instanceDir, null, null);
	}
	
	public SearchContextLoader(String instanceDir, ClassLoader parent, 
