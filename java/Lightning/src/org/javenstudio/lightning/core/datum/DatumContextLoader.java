...
public class DatumContextLoader extends DOMContextLoader 
		implements ResourceLoader {
	private static final Logger LOG = Logger.getLogger(DatumContextLoader.class);
	...
	public DatumContextLoader(String instanceDir) { 
		this(instanceDir, null, null);
	}
	
	public DatumContextLoader(String instanceDir, ClassLoader parent, 
