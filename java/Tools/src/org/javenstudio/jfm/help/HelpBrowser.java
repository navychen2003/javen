package org.javenstudio.jfm.help;
...
public class HelpBrowser extends JDialog {
  ...
  private JButton backButton = new JButton(Strings.get("Back")); 
  private JButton forwardButton = new JButton(Strings.get("Forward"));
  private JButton homeButton = new JButton(Strings.get("Home"));
  private JButton closeButton = new JButton(Strings.get("Close"));
  private JButton printButton = new JButton(Strings.get("Print"));
  ...
  private void init() {
    setIconImage(new ImageIcon(getClass().getResource("/images/icons/help-browser.png")).getImage());
    setSize(650, 500);
        ...
        try {
          ...
          if(service != null) {
            ...
            try {            
              ...
              exc.printStackTrace();
              JOptionPane.showMessageDialog(HelpBrowser.this, 
                  Strings.format("Error printing: %1$s", exc.getMessage()), Strings.get("Error"), 
                  JOptionPane.ERROR_MESSAGE);
            }
          } else {
            JOptionPane.showMessageDialog(HelpBrowser.this, 
                Strings.get("Can't find a printer"), Strings.get("Error"), 
                JOptionPane.ERROR_MESSAGE);
          }
        } catch (Exception exc) {
          exc.printStackTrace();
  ...
  public void loadPage(String url) {
    ...
    try {
      ...
      JOptionPane.showMessageDialog(HelpBrowser.this, 
          Strings.format("Error loading %1$s",url), Strings.get("Error"), JOptionPane.ERROR_MESSAGE);
      exc.printStackTrace();
    }
