...
public class ColorConfigurationPanel extends ConfigurationPanel {
  ...
  private void setPanel(){
    ...
    JPanel markedBackgroundPanel = setupMarkedBackgroundPanel();
    panel.add(foregroundColorPanel, new GridBagConstraints(0,0,1,1,1,0, 
        GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(10,0,0,0),0,0));
    panel.add(backgroundColorPanel, new GridBagConstraints(0,1,1,1,1,0,
        GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(5,0,0,0),0,0));
    panel.add(markedColorPanel, new GridBagConstraints(0,2,1,1,1,0,
        GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(5,0,0,0),0,0));
    panel.add(markedBackgroundPanel, new GridBagConstraints(0,3,1,1,1,0,
        GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(5,0,0,0),0,0));
    panel.add(new JPanel(), new GridBagConstraints(0,4,1,1,1,1,
  ...
  private JPanel setupForegroundColorPanel(){
    ...
    p.setBorder(BorderFactory.createTitledBorder(
        BorderFactory.createEtchedBorder(),Strings.get("Font color")));
    ...
    JButton button=new JButton(Strings.get("Add custom color"));
    button.addActionListener(new ActionListener(){
      public void actionPerformed(ActionEvent e){
        Color c=JColorChooser.showDialog(ColorConfigurationPanel.this,
            Strings.get("Font color"),Options.getForegroundColor());
        if(c==null) return;
        model.addElement(c);
        model.setSelectedItem(c);
      }
    });
    JButton rbutton=new JButton(Strings.get("Reset"));
  ...
  private JPanel setupBackgroundColorPanel(){
    JPanel p=new JPanel();
    p.setBorder(BorderFactory.createTitledBorder(
        BorderFactory.createEtchedBorder(),Strings.get("Panel color")));
    JComboBox combo=new JComboBox();
    combo.setEditable(false);
    combo.setRenderer(new ColorComboBoxRenderer());
    final DefaultComboBoxModel model=new DefaultComboBoxModel();
    ...
    button.addActionListener(new ActionListener(){
      public void actionPerformed(ActionEvent e){
        Color c=JColorChooser.showDialog(ColorConfigurationPanel.this,
            Strings.get("Panel color"),Options.getForegroundColor());
        if(c==null) return;
        model.addElement(c);
        model.setSelectedItem(c);        
      }
  ...
  private JPanel setupMarkedColorPanel(){
    JPanel p=new JPanel();
    p.setBorder(BorderFactory.createTitledBorder(
        BorderFactory.createEtchedBorder(),Strings.get("Marked font color")));
    JComboBox combo=new JComboBox();
    combo.setEditable(false);
    combo.setRenderer(new ColorComboBoxRenderer());
    final DefaultComboBoxModel model=new DefaultComboBoxModel();
    ...
    button.addActionListener(new ActionListener(){
      public void actionPerformed(ActionEvent e){
        Color c=JColorChooser.showDialog(ColorConfigurationPanel.this, 
            Strings.get("Marked font color"),Options.getMarkedColor());
        if(c==null) return;
        model.addElement(c);
        model.setSelectedItem(c);        
      }
  ...
  @SuppressWarnings({ "rawtypes", "unchecked" })
  private JPanel setupMarkedBackgroundPanel() {
    JPanel p = new JPanel();
    p.setBorder(BorderFactory.createTitledBorder(
        BorderFactory.createEtchedBorder(), Strings.get("Marked background color")));
    JComboBox combo = new JComboBox();
    combo.setEditable(false);
    combo.setRenderer(new ColorComboBoxRenderer());
    final DefaultComboBoxModel model = new DefaultComboBoxModel();
    combo.setModel(model);
    addComboItems(model);
    Color defaultColor = Options.getMarkedBackground();
    if (model.getIndexOf(defaultColor) >= 0) {
      model.setSelectedItem(defaultColor);
    } else {
      model.addElement(defaultColor);
    ...
    button.addActionListener(new ActionListener(){
      public void actionPerformed(ActionEvent e){
        Color c = JColorChooser.showDialog(ColorConfigurationPanel.this, 
            Strings.get("Marked background color"), Options.getMarkedColor());
        if (c == null) return;
        model.addElement(c);
        model.setSelectedItem(c);
      }
    ...
    rbutton.addActionListener(new ActionListener(){
      public void actionPerformed(ActionEvent e){
        Color c = Options.getDefaultMarkedBackground();
          if (c == null) return;
        if (model.getIndexOf(c) >= 0) {
          model.setSelectedItem(c);
        }else{
    ...
    combo.addActionListener(new ActionListener(){
      public void actionPerformed(ActionEvent e){
        ColorChangeEvent event = new ColorChangeEvent(ColorChangeEvent.MARKEDBACKGROUND);
        event.setSource(this);
        event.setColor((Color)model.getSelectedItem());
        ConfigurationEventsQueue.addPendingEvent(event);
      }
