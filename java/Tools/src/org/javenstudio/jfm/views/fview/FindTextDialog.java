...
public class FindTextDialog extends JDialog {
  ...
  void jbInit() throws Exception {
    ...
    jLabel1.setText(Strings.get("Find:"));
    ...
    optionsPanel.setBounds(new Rectangle(4, 83, 201, 157));
    optionsPanel.setLayout(flowLayout2);
    caseSensitiveCheckBox.setText(Strings.get("Case Sensitive"));
    fileStartCheckBox.setText(Strings.get("From file start"));
    wholeWordCheckBox.setText(Strings.get("Whole word only"));
    flowLayout2.setAlignment(FlowLayout.LEFT);
    this.setForeground(UIManager.getColor("Label.foreground"));
    regexpCheckBox.setText(Strings.get("Regular Expresion"));
    ...
    if (javaVersion != null && javaVersion.length() > 0 && javaVersion.indexOf("1.4") >= 0) {
      ...
      regexpCheckBox.setToolTipText(Strings.get("Must have JDK 1.4 to be able to use this."));
    }
    
    jLabel2.setText(Strings.get("Replace with:"));
    ...
    findNextButton.setText(Strings.get("Find Next"));
    ...
    replaceButton.setText(Strings.get("Replace"));
    ...
    replaceAllButton.setText(Strings.get("Replace All"));
  ...
  void findNextButton_actionPerformed(ActionEvent e) {
    listener.find(findText.getText(), null, 
        caseSensitiveCheckBox.isSelected(), 
        fileStartCheckBox.isSelected(), 
  ...
  void replaceButton_actionPerformed(ActionEvent e) {
    listener.find(findText.getText(), replaceText.getText(), 
        caseSensitiveCheckBox.isSelected(), 
        fileStartCheckBox.isSelected(), 
        wholeWordCheckBox.isSelected(), 
        regexpCheckBox.isSelected(), 
  ...
  void replaceAllButton_actionPerformed(ActionEvent e) {
    listener.all(findText.getText(), replaceText.getText(), 
        caseSensitiveCheckBox.isSelected(), 
        fileStartCheckBox.isSelected(), 
        wholeWordCheckBox.isSelected(), 
        regexpCheckBox.isSelected());    
