...
/**
 * This class is the base class of an File object. It is supposed to 
 * be implemented by every filesystem implementation.
 * The methods implemented by this class are very similar to those 
 * offered by the java.io.File class found in the JDK.
 * Even the comments are the same. Why? Because, IMHO, 
 * java.io.File represents a very good abstractisation of an file object
 * but I can't use it, because of the way its implemented. Or ... 
 * I haven't found a way to use it yet.
 * If somebody will point me to the proper documentation, i will be 
 * more than happy to study it, to see how can I improve my skills.
 *
 * @author sergiu
 */
...
public abstract class JFMFile implements Comparable {
  ...
  private boolean hasGotMimeType = false; 
  ...
  /**
   * This parameter, if setted to a different value than <code>null</code> 
   ...
   */
  public abstract JFMFile[] listFiles() throws IOException;
  ...
  /**
   * This string represents the short name of the filesystem
   */
  public abstract String getFsName();
  public abstract String getFsSchemeName();
   ...
   *
   * @see     org.javenstudio.jfm.filesystems.JFMFile#isAbsolute()
   */
   ...
   *          If a required system property value cannot be accessed.
   */
  public abstract JFMFile getCanonicalFile() throws IOException;
  ...
  public String getMimeType() {
    if (hasGotMimeType) return mimeType; 
    mimeType = guessMimeType(this); 
    hasGotMimeType = true; 
    return mimeType; 
  }
   ...
   */
  public abstract JFMFile mkdir(String name, String path) throws IOException;
  public abstract JFMFile mkdir(JFMFile dir) throws IOException;

  public void mkdir() throws IOException {
    if (!exists()) mkdir(this); 
  }

  /**
   * Rename the file/directory named by the abstract pathname.
   */
  public abstract boolean rename(String name) throws IOException;

  public abstract boolean renameTo(JFMFile newfile) throws IOException;

  /**
   * Creates the file named by the abstract pathname denoted by the parameter.
   */
  public abstract boolean createNewFile(String name, String path) throws IOException;
   ...
   *          method does not permit the named directory to be created
   */
  public abstract JFMFile createFile(String name, String path) throws IOException;
  ...
  /**
   * Returns the filesystem's icon associated with this file, 
  ...
  public static String guessMimeType(JFMFile file) {
    return guessMimeType(file, null); 
  }

  public static String guessMimeType(JFMFile file, byte[] data) {
    String mime = null;
  ...
  private static Object lockIcon = new Object(); 

  protected static void registerIcon(JFMFile file, Icon icon) {
    if (file == null || icon == null) return; 
    String name = file.getName(); 
    String ext = file.isFile() ? getExtensionName(name) : null; 
    if (ext == null || ext.length() == 0)
      return; 
    if (ext.equals("exe")) return; 
    synchronized (lockIcon) {
  ...
  protected static Icon getRegisteredIcon(JFMFile file) {
  ...
  private static String getExtensionName(String name) {
