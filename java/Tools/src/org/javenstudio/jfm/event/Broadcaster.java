...
/**
  * This is the class that registers the listeners, removes listeners, 
  * and notifies the listeners when a certain event occurs.
  */
...
public class Broadcaster {
  ...
  public static void addBrowseDirectoryListener(BrowseDirectoryListener listener) {
    addListener(BrowseDirectoryListener.class, listener);
  }

  public static void removeBrowseDirectoryListener(BrowseDirectoryListener listener) {
    removeListener(BrowseDirectoryListener.class, listener);
  }

  public static void notifyBrowseDirectoryListeners(BrowseDirectoryEvent event) {
    Iterator it = getListenerIterator(BrowseDirectoryListener.class);
    BrowseDirectoryListener listener;
    while (it.hasNext()) {
      listener = (BrowseDirectoryListener)it.next();
      listener.browseDirectory(event);
    }
  }

  public static void addChangeSelectionListener(ChangeSelectionListener listener) {
    addListener(ChangeSelectionListener.class, listener);
  }

  public static void removeChangeSelectionListener(ChangeSelectionListener listener) {
    removeListener(ChangeSelectionListener.class, listener);
  }

  public static void notifyChangeSelectionListeners(ChangeSelectionEvent event) {
    Iterator it = getListenerIterator(ChangeSelectionListener.class);
    ChangeSelectionListener listener;
    while (it.hasNext()) { 
      listener = (ChangeSelectionListener)it.next();
      listener.changeSelection(event);
    } 
  }

  public static void addChangeStatusListener(ChangeStatusListener listener) {
    addListener(ChangeStatusListener.class, listener);
  }

  public static void removeChangeStatusListener(ChangeStatusListener listener) {
    removeListener(ChangeStatusListener.class, listener);
  }

  public static void notifyChangeStatusListeners(ChangeStatusEvent event) {
    Iterator it = getListenerIterator(ChangeStatusListener.class);
    ChangeStatusListener listener;
    while (it.hasNext()) {
      listener = (ChangeStatusListener)it.next();
