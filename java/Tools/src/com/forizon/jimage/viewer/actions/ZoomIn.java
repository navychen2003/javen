...
public class ZoomIn extends AbstractAction {
    ...
    public ZoomIn(Context aContext) {
        super(aContext);
     }
    ...
    public void setValues() {
        ...
        putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke("control PLUS"));
        putValue(SMALL_ICON, new javax.swing.ImageIcon(getClass().getResource("/images/icons/zoom-in.png")));
    }
