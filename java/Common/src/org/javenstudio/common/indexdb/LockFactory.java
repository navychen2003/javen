...
/**
 * <p>Base class for Locking implementation.  {@link IDirectory} uses
...
public abstract class LockFactory {
	...
	protected String mLockPrefix = null;
	 ...
	 * is helpful if you're running Indexdb on machines that
	 * have different mount points for the same shared
	 * directory.
	 */
	public void setLockPrefix(String lockPrefix) {
		mLockPrefix = lockPrefix;
	}
