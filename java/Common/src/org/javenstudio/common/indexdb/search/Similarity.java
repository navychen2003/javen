...
/** 
 * Similarity defines the components of Indexdb scoring.
 * <p>
 * Expert: Scoring API.
 * <p>
 * This is a low-level API, you should only extend this API if you want to implement 
 * an information retrieval <i>model</i>.  If you are instead looking for a convenient way 
 * to alter Indexdb's scoring, consider extending a higher-level implementation
 ...
 * <p>
 * Similarity determines how Indexdb weights terms, and Indexdb interacts with
 ...
 * be later accessible via {@link AtomicReader#normValues(String)}. IndexDb makes no assumption
 * about what is in this norm, but it is most useful for encoding length normalization 
 * information.
 * <p>
 * Implementations should carefully consider how the normalization is encoded: while
 * Indexdb's classical {@link TFIDFSimilarity} encodes a combination of index-time boost
 ...
 *       of statistics without causing any additional I/O. Indexdb makes no assumption about what is 
 ...
 *   <li>For each segment in the index, the Query creates a {@link #exactSimScorer(SimWeight, IAtomicReaderRef)}
 *       (for queries with exact frequencies such as TermQuerys and exact PhraseQueries) or a 
 *       {@link #sloppySimScorer(SimWeight, IAtomicReaderRef)} (for queries with sloppy frequencies such as
 ...
 * was computed.
 *
 * @see IndexParams#setSimilarity(Similarity)
 * @see IndexSearcher#setSimilarity(Similarity)
 */
public abstract class Similarity implements ISimilarity {
	 ...
	 */
	public abstract void computeNorm(IFieldState state, INorm norm);
	 ...
	 */
	public abstract ISimilarityWeight computeWeight(float queryBoost, 
	 ...
	 * @throws IOException
	 */
	public abstract IExactSimilarityScorer getExactSimilarityScorer(ISimilarityWeight weight, 
	 ...
	 * @throws IOException
	 */
	public abstract ISloppySimilarityScorer getSloppySimilarityScorer(ISimilarityWeight weight, 
			IAtomicReaderRef context) throws IOException;
	 ...
	 */
	public static abstract class ExactSimilarityScorer implements IExactSimilarityScorer {
		/**
	 ...
	 */
	public static abstract class SloppySimilarityScorer implements ISloppySimilarityScorer {
		/**
		 * Score a single document
	 ...
	 */
	public static abstract class SimilarityWeight implements ISimilarityWeight {
