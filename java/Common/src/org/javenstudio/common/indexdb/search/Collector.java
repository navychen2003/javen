 ...
 *
 * <p>Indexdb's core collectors are derived from Collector.
 ...
 * 
 * <p><b>NOTE:</b> Prior to 2.9, Indexdb silently filtered
...
public abstract class Collector implements ICollector {
	 ...
	 */
	public abstract void setScorer(IScorer scorer) throws IOException;
	 ...
	 */
	public abstract void setNextReader(IAtomicReaderRef context) throws IOException;
