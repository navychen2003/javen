 ...
 * Remove once Indexdb is on Java 7.
 * 
 */
public final class IOUtils {
  ...
  /**
   * <p>Closes all given <tt>Closeable</tt>s, suppressing all thrown exceptions. 
   * Some of the <tt>Closeable</tt>s
   * may be null, they are ignored. After everything is closed, 
   * method either throws <tt>priorException</tt>,
   ...
   * </pre>
   * </p>
   * @param priorException  <tt>null</tt> or an exception that will be rethrown 
   * after method completion
   * @param objects         objects to call <tt>close()</tt> on
   */
  public static <E extends Exception> 
  		void closeWhileHandlingException(E priorException, Closeable... objects) 
  ...
  public static <E extends Exception> 
  		void closeWhileHandlingException(E priorException, Iterable<? extends Closeable> objects) 
  		throws E, IOException {
    Throwable th = null;
