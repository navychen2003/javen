 ...
 * </ul>
 * A new <code>TokenStream</code> API has been introduced with Indexdb 2.9. This API
 ...
 * can be used.
 * <p>The {@code TokenStream}-API in Indexdb is based on the decorator pattern.
 ...
 */
public abstract class TokenStream implements ITokenStream {
	 ...
	 */
	@Override
	public abstract IToken nextToken() throws IOException;
