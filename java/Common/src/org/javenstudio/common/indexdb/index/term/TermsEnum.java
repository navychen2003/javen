 ...
 *
 */
public abstract class TermsEnum implements ITermsEnum {

	private float mBoost = 1.0f;
	
	public float getBoost() { return mBoost; }
	public void setBoost(float boost) { mBoost = boost; }
	 ...
	 */
	public abstract long getOrd() throws IOException;
	 ...
	 *  {@link SeekStatus#END}.
	 */
	public abstract int getDocFreq() throws IOException;
	 ...
	 */
	public abstract long getTotalTermFreq() throws IOException;
	...
	public IDocsEnum getDocs(Bits liveDocs, IDocsEnum reuse) 
			throws IOException { 
		return getDocs(liveDocs, reuse, IDocsEnum.FLAG_FREQS);
	}
	 ...
	 */
	public abstract IDocsEnum getDocs(Bits liveDocs, IDocsEnum reuse, 
	...
	public IDocsAndPositionsEnum getDocsAndPositions(Bits liveDocs, 
		...
		return getDocsAndPositions(liveDocs, reuse, 
	 ...
	 */
	public abstract IDocsAndPositionsEnum getDocsAndPositions(Bits liveDocs, 
	...
	public static final TermsEnum EMPTY = new TermsEnum() {    
		...
		@Override
		public IDocsAndPositionsEnum getDocsAndPositions(Bits liveDocs, IDocsAndPositionsEnum reuse, int flags) {
			throw new IllegalStateException("this method should never be called");
		}
