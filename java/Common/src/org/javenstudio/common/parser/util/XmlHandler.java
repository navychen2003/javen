...
public abstract class XmlHandler implements TagHandler {
	...
	protected final void handleElementBegin(XmlElement e) { 
		if (e == null) return; 
	...
	protected final void handleElementEnd(XmlElement e, int endLength) { 
		if (e == null) return; 
	...
	protected void setNodeAttributes(Node node, XmlElement e) { 
		...
		for (int i=0; i < e.getAttributeSize(); i++) { 
