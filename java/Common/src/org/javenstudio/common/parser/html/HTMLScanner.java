...
import org.javenstudio.common.parser.ScanHandler;
import org.javenstudio.common.parser.Scanner;
...
public class HTMLScanner implements Scanner, Locator {
	...
	public void scan(Reader r0, ScanHandler h) throws IOException, SAXException {
		...
		while (theState != S_DONE) {
			...
			switch (action) {
			case 0:
				throw new Error("HTMLScanner can't cope with " + Integer.toString(ch) + " in state " +
