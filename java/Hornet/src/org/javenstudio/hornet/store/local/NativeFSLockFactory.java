...
import org.javenstudio.common.indexdb.store.local.FSLockFactory;
...
public final class NativeFSLockFactory extends FSLockFactory {
	...
	public synchronized Lock makeLock(String lockName) {
		...
		return new NativeFSLock(mLockDir, lockName);
	}
	...
	public void clearLock(String lockName) throws IOException {
		...
		if (mLockDir.exists()) {
			...
			new File(mLockDir, lockName).delete();
		}
	}
	...
	private class NativeFSLock extends Lock {
		private RandomAccessFile mFile;
		private FileChannel mChannel;
		private FileLock mLock;
		private File mPath;
		private File mLockDir;

		public NativeFSLock(File lockDir, String lockFileName) {
			mLockDir = lockDir;
			mPath = new File(lockDir, lockFileName);
		}
		...
		public synchronized boolean obtain() throws IOException {
			...
			String canonicalPath = mPath.getCanonicalPath();
				...
				try {
					...
					try {
						...
						try {
							...
							mFile = null;
							synchronized(LOCK_HELD) {
								LOCK_HELD.remove(mPath.getCanonicalPath());
							}
						}
					}
				}
