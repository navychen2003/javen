...
abstract class BulkOperation {
	...
	static final EnumMap<Format, BulkOperation[]> BULK_OPERATIONS = 
			 new EnumMap<Format, BulkOperation[]>(Format.class);
	 ...
	 */
	public abstract void get(long[] blocks, int blockIndex, 
			long[] values, int valuesIndex, int iterations);

	/**
	 * Set <code>n * values()</code> values into <code>n * blocks()</code> blocks.
	 */
	public abstract void set(long[] blocks, int blockIndex, 
			long[] values, int valuesIndex, int iterations);

	static {
		BULK_OPERATIONS.put(Format.PACKED, new BulkOperation[65]);
		BULK_OPERATIONS.get(Format.PACKED)[1] = new Packed64BulkOperation1();
		BULK_OPERATIONS.get(Format.PACKED)[2] = new Packed64BulkOperation2();
		BULK_OPERATIONS.get(Format.PACKED)[3] = new Packed64BulkOperation3();
		BULK_OPERATIONS.get(Format.PACKED)[4] = new Packed64BulkOperation4();
		BULK_OPERATIONS.get(Format.PACKED)[5] = new Packed64BulkOperation5();
		BULK_OPERATIONS.get(Format.PACKED)[6] = new Packed64BulkOperation6();
		BULK_OPERATIONS.get(Format.PACKED)[7] = new Packed64BulkOperation7();
		BULK_OPERATIONS.get(Format.PACKED)[8] = new Packed64BulkOperation8();
		BULK_OPERATIONS.get(Format.PACKED)[9] = new Packed64BulkOperation9();
		BULK_OPERATIONS.get(Format.PACKED)[10] = new Packed64BulkOperation10();
		BULK_OPERATIONS.get(Format.PACKED)[11] = new Packed64BulkOperation11();
		BULK_OPERATIONS.get(Format.PACKED)[12] = new Packed64BulkOperation12();
		BULK_OPERATIONS.get(Format.PACKED)[13] = new Packed64BulkOperation13();
		BULK_OPERATIONS.get(Format.PACKED)[14] = new Packed64BulkOperation14();
		BULK_OPERATIONS.get(Format.PACKED)[15] = new Packed64BulkOperation15();
		BULK_OPERATIONS.get(Format.PACKED)[16] = new Packed64BulkOperation16();
		BULK_OPERATIONS.get(Format.PACKED)[17] = new Packed64BulkOperation17();
		BULK_OPERATIONS.get(Format.PACKED)[18] = new Packed64BulkOperation18();
		BULK_OPERATIONS.get(Format.PACKED)[19] = new Packed64BulkOperation19();
		BULK_OPERATIONS.get(Format.PACKED)[20] = new Packed64BulkOperation20();
		BULK_OPERATIONS.get(Format.PACKED)[21] = new Packed64BulkOperation21();
		BULK_OPERATIONS.get(Format.PACKED)[22] = new Packed64BulkOperation22();
		BULK_OPERATIONS.get(Format.PACKED)[23] = new Packed64BulkOperation23();
    	BULK_OPERATIONS.get(Format.PACKED)[24] = new Packed64BulkOperation24();
    	BULK_OPERATIONS.get(Format.PACKED)[25] = new Packed64BulkOperation25();
    	BULK_OPERATIONS.get(Format.PACKED)[26] = new Packed64BulkOperation26();
    	BULK_OPERATIONS.get(Format.PACKED)[27] = new Packed64BulkOperation27();
    	BULK_OPERATIONS.get(Format.PACKED)[28] = new Packed64BulkOperation28();
    	BULK_OPERATIONS.get(Format.PACKED)[29] = new Packed64BulkOperation29();
    	BULK_OPERATIONS.get(Format.PACKED)[30] = new Packed64BulkOperation30();
    	BULK_OPERATIONS.get(Format.PACKED)[31] = new Packed64BulkOperation31();
    	BULK_OPERATIONS.get(Format.PACKED)[32] = new Packed64BulkOperation32();
    	BULK_OPERATIONS.get(Format.PACKED)[33] = new Packed64BulkOperation33();
    	BULK_OPERATIONS.get(Format.PACKED)[34] = new Packed64BulkOperation34();
    	BULK_OPERATIONS.get(Format.PACKED)[35] = new Packed64BulkOperation35();
    	BULK_OPERATIONS.get(Format.PACKED)[36] = new Packed64BulkOperation36();
    	BULK_OPERATIONS.get(Format.PACKED)[37] = new Packed64BulkOperation37();
    	BULK_OPERATIONS.get(Format.PACKED)[38] = new Packed64BulkOperation38();
    	BULK_OPERATIONS.get(Format.PACKED)[39] = new Packed64BulkOperation39();
    	BULK_OPERATIONS.get(Format.PACKED)[40] = new Packed64BulkOperation40();
    	BULK_OPERATIONS.get(Format.PACKED)[41] = new Packed64BulkOperation41();
    	BULK_OPERATIONS.get(Format.PACKED)[42] = new Packed64BulkOperation42();
    	BULK_OPERATIONS.get(Format.PACKED)[43] = new Packed64BulkOperation43();
    	BULK_OPERATIONS.get(Format.PACKED)[44] = new Packed64BulkOperation44();
    	BULK_OPERATIONS.get(Format.PACKED)[45] = new Packed64BulkOperation45();
    	BULK_OPERATIONS.get(Format.PACKED)[46] = new Packed64BulkOperation46();
    	BULK_OPERATIONS.get(Format.PACKED)[47] = new Packed64BulkOperation47();
    	BULK_OPERATIONS.get(Format.PACKED)[48] = new Packed64BulkOperation48();
    	BULK_OPERATIONS.get(Format.PACKED)[49] = new Packed64BulkOperation49();
    	BULK_OPERATIONS.get(Format.PACKED)[50] = new Packed64BulkOperation50();
    	BULK_OPERATIONS.get(Format.PACKED)[51] = new Packed64BulkOperation51();
    	BULK_OPERATIONS.get(Format.PACKED)[52] = new Packed64BulkOperation52();
    	BULK_OPERATIONS.get(Format.PACKED)[53] = new Packed64BulkOperation53();
    	BULK_OPERATIONS.get(Format.PACKED)[54] = new Packed64BulkOperation54();
    	BULK_OPERATIONS.get(Format.PACKED)[55] = new Packed64BulkOperation55();
    	BULK_OPERATIONS.get(Format.PACKED)[56] = new Packed64BulkOperation56();
    	BULK_OPERATIONS.get(Format.PACKED)[57] = new Packed64BulkOperation57();
    	BULK_OPERATIONS.get(Format.PACKED)[58] = new Packed64BulkOperation58();
    	BULK_OPERATIONS.get(Format.PACKED)[59] = new Packed64BulkOperation59();
    	BULK_OPERATIONS.get(Format.PACKED)[60] = new Packed64BulkOperation60();
    	BULK_OPERATIONS.get(Format.PACKED)[61] = new Packed64BulkOperation61();
    	BULK_OPERATIONS.get(Format.PACKED)[62] = new Packed64BulkOperation62();
    	BULK_OPERATIONS.get(Format.PACKED)[63] = new Packed64BulkOperation63();
    	BULK_OPERATIONS.get(Format.PACKED)[64] = new Packed64BulkOperation64();
    	BULK_OPERATIONS.put(Format.PACKED_SINGLE_BLOCK, new BulkOperation[65]);
    	BULK_OPERATIONS.get(Format.PACKED_SINGLE_BLOCK)[1] = new Packed64SingleBlockBulkOperation1();
    	BULK_OPERATIONS.get(Format.PACKED_SINGLE_BLOCK)[2] = new Packed64SingleBlockBulkOperation2();
    	BULK_OPERATIONS.get(Format.PACKED_SINGLE_BLOCK)[3] = new Packed64SingleBlockBulkOperation3();
    	BULK_OPERATIONS.get(Format.PACKED_SINGLE_BLOCK)[4] = new Packed64SingleBlockBulkOperation4();
    	BULK_OPERATIONS.get(Format.PACKED_SINGLE_BLOCK)[5] = new Packed64SingleBlockBulkOperation5();
    	BULK_OPERATIONS.get(Format.PACKED_SINGLE_BLOCK)[6] = new Packed64SingleBlockBulkOperation6();
    	BULK_OPERATIONS.get(Format.PACKED_SINGLE_BLOCK)[7] = new Packed64SingleBlockBulkOperation7();
    	BULK_OPERATIONS.get(Format.PACKED_SINGLE_BLOCK)[8] = new Packed64SingleBlockBulkOperation8();
    	BULK_OPERATIONS.get(Format.PACKED_SINGLE_BLOCK)[9] = new Packed64SingleBlockBulkOperation9();
    	BULK_OPERATIONS.get(Format.PACKED_SINGLE_BLOCK)[10] = new Packed64SingleBlockBulkOperation10();
    	BULK_OPERATIONS.get(Format.PACKED_SINGLE_BLOCK)[12] = new Packed64SingleBlockBulkOperation12();
    	BULK_OPERATIONS.get(Format.PACKED_SINGLE_BLOCK)[16] = new Packed64SingleBlockBulkOperation16();
    	BULK_OPERATIONS.get(Format.PACKED_SINGLE_BLOCK)[21] = new Packed64SingleBlockBulkOperation21();
    	BULK_OPERATIONS.get(Format.PACKED_SINGLE_BLOCK)[32] = new Packed64SingleBlockBulkOperation32();
	}
	
	static final class Packed64BulkOperation1 extends BulkOperation {
		public int blocks() { return 1; }
		public int values() { return 64; }
		...
		public void set(long[] blocks, int bi, long[] values, int vi, int iterations) {
			...
			for (int i = 0; i < iterations; ++i) {
				blocks[bi++] = 
						(values[vi++] << 63) | (values[vi++] << 62) | (values[vi++] << 61) | 
						(values[vi++] << 60) | (values[vi++] << 59) | (values[vi++] << 58) | 
						(values[vi++] << 57) | (values[vi++] << 56) | (values[vi++] << 55) | 
						(values[vi++] << 54) | (values[vi++] << 53) | (values[vi++] << 52) | 
						(values[vi++] << 51) | (values[vi++] << 50) | (values[vi++] << 49) | 
						(values[vi++] << 48) | (values[vi++] << 47) | (values[vi++] << 46) | 
						(values[vi++] << 45) | (values[vi++] << 44) | (values[vi++] << 43) | 
						(values[vi++] << 42) | (values[vi++] << 41) | (values[vi++] << 40) | 
						(values[vi++] << 39) | (values[vi++] << 38) | (values[vi++] << 37) | 
						(values[vi++] << 36) | (values[vi++] << 35) | (values[vi++] << 34) | 
						(values[vi++] << 33) | (values[vi++] << 32) | (values[vi++] << 31) | 
						(values[vi++] << 30) | (values[vi++] << 29) | (values[vi++] << 28) | 
						(values[vi++] << 27) | (values[vi++] << 26) | (values[vi++] << 25) | 
						(values[vi++] << 24) | (values[vi++] << 23) | (values[vi++] << 22) | 
						(values[vi++] << 21) | (values[vi++] << 20) | (values[vi++] << 19) | 
						(values[vi++] << 18) | (values[vi++] << 17) | (values[vi++] << 16) | 
						(values[vi++] << 15) | (values[vi++] << 14) | (values[vi++] << 13) | 
						(values[vi++] << 12) | (values[vi++] << 11) | (values[vi++] << 10) | 
						(values[vi++] << 9) | (values[vi++] << 8) | (values[vi++] << 7) | 
						(values[vi++] << 6) | (values[vi++] << 5) | (values[vi++] << 4) | 
						(values[vi++] << 3) | (values[vi++] << 2) | (values[vi++] << 1) | 
						values[vi++];
			}
		}
	}
	...
	static final class Packed64BulkOperation2 extends BulkOperation {
		...
		public void set(long[] blocks, int bi, long[] values, int vi, int iterations) {
			...
			for (int i = 0; i < iterations; ++i) {
				blocks[bi++] = 
						(values[vi++] << 62) | (values[vi++] << 60) | (values[vi++] << 58) | 
						(values[vi++] << 56) | (values[vi++] << 54) | (values[vi++] << 52) | 
						(values[vi++] << 50) | (values[vi++] << 48) | (values[vi++] << 46) | 
						(values[vi++] << 44) | (values[vi++] << 42) | (values[vi++] << 40) | 
						(values[vi++] << 38) | (values[vi++] << 36) | (values[vi++] << 34) | 
						(values[vi++] << 32) | (values[vi++] << 30) | (values[vi++] << 28) | 
						(values[vi++] << 26) | (values[vi++] << 24) | (values[vi++] << 22) | 
						(values[vi++] << 20) | (values[vi++] << 18) | (values[vi++] << 16) | 
						(values[vi++] << 14) | (values[vi++] << 12) | (values[vi++] << 10) | 
						(values[vi++] << 8) | (values[vi++] << 6) | (values[vi++] << 4) | 
						(values[vi++] << 2) | values[vi++];
			}
		}
	}

	static final class Packed64BulkOperation3 extends BulkOperation {
		public int blocks() { return 3; }
		public int values() { return 64; }
		...
		public void set(long[] blocks, int bi, long[] values, int vi, int iterations) {
			...
			for (int i = 0; i < iterations; ++i) {
				blocks[bi++] = 
						(values[vi++] << 61) | (values[vi++] << 58) | (values[vi++] << 55) | 
						(values[vi++] << 52) | (values[vi++] << 49) | (values[vi++] << 46) | 
						(values[vi++] << 43) | (values[vi++] << 40) | (values[vi++] << 37) | 
						(values[vi++] << 34) | (values[vi++] << 31) | (values[vi++] << 28) | 
						(values[vi++] << 25) | (values[vi++] << 22) | (values[vi++] << 19) | 
						(values[vi++] << 16) | (values[vi++] << 13) | (values[vi++] << 10) | 
						(values[vi++] << 7) | (values[vi++] << 4) | (values[vi++] << 1) | 
						(values[vi] >>> 2);
				blocks[bi++] = 
						(values[vi++] << 62) | (values[vi++] << 59) | (values[vi++] << 56) | 
						(values[vi++] << 53) | (values[vi++] << 50) | (values[vi++] << 47) | 
						(values[vi++] << 44) | (values[vi++] << 41) | (values[vi++] << 38) | 
						(values[vi++] << 35) | (values[vi++] << 32) | (values[vi++] << 29) | 
						(values[vi++] << 26) | (values[vi++] << 23) | (values[vi++] << 20) | 
						(values[vi++] << 17) | (values[vi++] << 14) | (values[vi++] << 11) | 
						(values[vi++] << 8) | (values[vi++] << 5) | (values[vi++] << 2) | 
						(values[vi] >>> 1);
				blocks[bi++] = 
						(values[vi++] << 63) | (values[vi++] << 60) | (values[vi++] << 57) | 
						(values[vi++] << 54) | (values[vi++] << 51) | (values[vi++] << 48) | 
						(values[vi++] << 45) | (values[vi++] << 42) | (values[vi++] << 39) | 
						(values[vi++] << 36) | (values[vi++] << 33) | (values[vi++] << 30) | 
						(values[vi++] << 27) | (values[vi++] << 24) | (values[vi++] << 21) | 
						(values[vi++] << 18) | (values[vi++] << 15) | (values[vi++] << 12) | 
						(values[vi++] << 9) | (values[vi++] << 6) | (values[vi++] << 3) | 
						values[vi++];
			}
		}
	}
	...
	static final class Packed64BulkOperation4 extends BulkOperation {
		...
		public void set(long[] blocks, int bi, long[] values, int vi, int iterations) {
			...
			for (int i = 0; i < iterations; ++i) {
				blocks[bi++] = 
						(values[vi++] << 60) | (values[vi++] << 56) | (values[vi++] << 52) | 
						(values[vi++] << 48) | (values[vi++] << 44) | (values[vi++] << 40) | 
						(values[vi++] << 36) | (values[vi++] << 32) | (values[vi++] << 28) | 
						(values[vi++] << 24) | (values[vi++] << 20) | (values[vi++] << 16) | 
						(values[vi++] << 12) | (values[vi++] << 8) | (values[vi++] << 4) | 
						values[vi++];
			}
		}
	}
	...
	static final class Packed64BulkOperation5 extends BulkOperation {
		...
		public void set(long[] blocks, int bi, long[] values, int vi, int iterations) {
			...
			for (int i = 0; i < iterations; ++i) {
				blocks[bi++] = 
						(values[vi++] << 59) | (values[vi++] << 54) | (values[vi++] << 49) | 
						(values[vi++] << 44) | (values[vi++] << 39) | (values[vi++] << 34) | 
						(values[vi++] << 29) | (values[vi++] << 24) | (values[vi++] << 19) | 
						(values[vi++] << 14) | (values[vi++] << 9) | (values[vi++] << 4) | 
						(values[vi] >>> 1);
				blocks[bi++] = 
						(values[vi++] << 63) | (values[vi++] << 58) | (values[vi++] << 53) | 
						(values[vi++] << 48) | (values[vi++] << 43) | (values[vi++] << 38) | 
						(values[vi++] << 33) | (values[vi++] << 28) | (values[vi++] << 23) | 
						(values[vi++] << 18) | (values[vi++] << 13) | (values[vi++] << 8) | 
						(values[vi++] << 3) | (values[vi] >>> 2);
				blocks[bi++] = 
						(values[vi++] << 62) | (values[vi++] << 57) | (values[vi++] << 52) | 
						(values[vi++] << 47) | (values[vi++] << 42) | (values[vi++] << 37) | 
						(values[vi++] << 32) | (values[vi++] << 27) | (values[vi++] << 22) | 
						(values[vi++] << 17) | (values[vi++] << 12) | (values[vi++] << 7) | 
						(values[vi++] << 2) | (values[vi] >>> 3);
				blocks[bi++] = 
						(values[vi++] << 61) | (values[vi++] << 56) | (values[vi++] << 51) | 
						(values[vi++] << 46) | (values[vi++] << 41) | (values[vi++] << 36) | 
						(values[vi++] << 31) | (values[vi++] << 26) | (values[vi++] << 21) | 
						(values[vi++] << 16) | (values[vi++] << 11) | (values[vi++] << 6) | 
						(values[vi++] << 1) | (values[vi] >>> 4);
				blocks[bi++] = 
						(values[vi++] << 60) | (values[vi++] << 55) | (values[vi++] << 50) | 
						(values[vi++] << 45) | (values[vi++] << 40) | (values[vi++] << 35) | 
						(values[vi++] << 30) | (values[vi++] << 25) | (values[vi++] << 20) | 
						(values[vi++] << 15) | (values[vi++] << 10) | (values[vi++] << 5) | 
						values[vi++];
			}
		}
	}
	...
	static final class Packed64BulkOperation6 extends BulkOperation {
		...
		public void set(long[] blocks, int bi, long[] values, int vi, int iterations) {
			...
			for (int i = 0; i < iterations; ++i) {
				blocks[bi++] = 
						(values[vi++] << 58) | (values[vi++] << 52) | (values[vi++] << 46) | 
						(values[vi++] << 40) | (values[vi++] << 34) | (values[vi++] << 28) | 
						(values[vi++] << 22) | (values[vi++] << 16) | (values[vi++] << 10) | 
						(values[vi++] << 4) | (values[vi] >>> 2);
				blocks[bi++] = 
						(values[vi++] << 62) | (values[vi++] << 56) | (values[vi++] << 50) | 
						(values[vi++] << 44) | (values[vi++] << 38) | (values[vi++] << 32) | 
						(values[vi++] << 26) | (values[vi++] << 20) | (values[vi++] << 14) | 
						(values[vi++] << 8) | (values[vi++] << 2) | (values[vi] >>> 4);
				blocks[bi++] = 
						(values[vi++] << 60) | (values[vi++] << 54) | (values[vi++] << 48) | 
						(values[vi++] << 42) | (values[vi++] << 36) | (values[vi++] << 30) | 
						(values[vi++] << 24) | (values[vi++] << 18) | (values[vi++] << 12) | 
						(values[vi++] << 6) | values[vi++];
			}
		}
	}

	static final class Packed64BulkOperation7 extends BulkOperation {
		public int blocks() { return 7; }
		public int values() { return 64; }
		...
		public void set(long[] blocks, int bi, long[] values, int vi, int iterations) {
			...
			for (int i = 0; i < iterations; ++i) {
				blocks[bi++] = 
						(values[vi++] << 57) | (values[vi++] << 50) | (values[vi++] << 43) | 
						(values[vi++] << 36) | (values[vi++] << 29) | (values[vi++] << 22) | 
						(values[vi++] << 15) | (values[vi++] << 8) | (values[vi++] << 1) | 
						(values[vi] >>> 6);
				blocks[bi++] = 
						(values[vi++] << 58) | (values[vi++] << 51) | (values[vi++] << 44) | 
						(values[vi++] << 37) | (values[vi++] << 30) | (values[vi++] << 23) | 
						(values[vi++] << 16) | (values[vi++] << 9) | (values[vi++] << 2) | 
						(values[vi] >>> 5);
				blocks[bi++] = 
						(values[vi++] << 59) | (values[vi++] << 52) | (values[vi++] << 45) | 
						(values[vi++] << 38) | (values[vi++] << 31) | (values[vi++] << 24) | 
						(values[vi++] << 17) | (values[vi++] << 10) | (values[vi++] << 3) | 
						(values[vi] >>> 4);
				blocks[bi++] = 
						(values[vi++] << 60) | (values[vi++] << 53) | (values[vi++] << 46) | 
						(values[vi++] << 39) | (values[vi++] << 32) | (values[vi++] << 25) | 
						(values[vi++] << 18) | (values[vi++] << 11) | (values[vi++] << 4) | 
						(values[vi] >>> 3);
				blocks[bi++] = 
						(values[vi++] << 61) | (values[vi++] << 54) | (values[vi++] << 47) | 
						(values[vi++] << 40) | (values[vi++] << 33) | (values[vi++] << 26) | 
						(values[vi++] << 19) | (values[vi++] << 12) | (values[vi++] << 5) | 
						(values[vi] >>> 2);
				blocks[bi++] = 
						(values[vi++] << 62) | (values[vi++] << 55) | (values[vi++] << 48) | 
						(values[vi++] << 41) | (values[vi++] << 34) | (values[vi++] << 27) | 
						(values[vi++] << 20) | (values[vi++] << 13) | (values[vi++] << 6) | 
						(values[vi] >>> 1);
				blocks[bi++] = 
						(values[vi++] << 63) | (values[vi++] << 56) | (values[vi++] << 49) | 
						(values[vi++] << 42) | (values[vi++] << 35) | (values[vi++] << 28) | 
						(values[vi++] << 21) | (values[vi++] << 14) | (values[vi++] << 7) | 
						values[vi++];
			}
		}
	}
	...
	static final class Packed64BulkOperation8 extends BulkOperation {
		...
		public void set(long[] blocks, int bi, long[] values, int vi, int iterations) {
			...
			for (int i = 0; i < iterations; ++i) {
				blocks[bi++] = 
						(values[vi++] << 56) | (values[vi++] << 48) | (values[vi++] << 40) | 
						(values[vi++] << 32) | (values[vi++] << 24) | (values[vi++] << 16) | 
						(values[vi++] << 8) | values[vi++];
			}
		}
	}

	static final class Packed64BulkOperation9 extends BulkOperation {
		public int blocks() { return 9; }
		public int values() { return 64; }
		...
		public void set(long[] blocks, int bi, long[] values, int vi, int iterations) {
			...
			for (int i = 0; i < iterations; ++i) {
				blocks[bi++] = 
						(values[vi++] << 55) | (values[vi++] << 46) | (values[vi++] << 37) | 
						(values[vi++] << 28) | (values[vi++] << 19) | (values[vi++] << 10) | 
						(values[vi++] << 1) | (values[vi] >>> 8);
				blocks[bi++] = 
						(values[vi++] << 56) | (values[vi++] << 47) | (values[vi++] << 38) | 
						(values[vi++] << 29) | (values[vi++] << 20) | (values[vi++] << 11) | 
						(values[vi++] << 2) | (values[vi] >>> 7);
				blocks[bi++] = 
						(values[vi++] << 57) | (values[vi++] << 48) | (values[vi++] << 39) | 
						(values[vi++] << 30) | (values[vi++] << 21) | (values[vi++] << 12) | 
						(values[vi++] << 3) | (values[vi] >>> 6);
				blocks[bi++] = 
						(values[vi++] << 58) | (values[vi++] << 49) | (values[vi++] << 40) | 
						(values[vi++] << 31) | (values[vi++] << 22) | (values[vi++] << 13) | 
						(values[vi++] << 4) | (values[vi] >>> 5);
				blocks[bi++] = 
						(values[vi++] << 59) | (values[vi++] << 50) | (values[vi++] << 41) | 
						(values[vi++] << 32) | (values[vi++] << 23) | (values[vi++] << 14) | 
						(values[vi++] << 5) | (values[vi] >>> 4);
				blocks[bi++] = 
						(values[vi++] << 60) | (values[vi++] << 51) | (values[vi++] << 42) | 
						(values[vi++] << 33) | (values[vi++] << 24) | (values[vi++] << 15) | 
						(values[vi++] << 6) | (values[vi] >>> 3);
				blocks[bi++] = 
						(values[vi++] << 61) | (values[vi++] << 52) | (values[vi++] << 43) | 
						(values[vi++] << 34) | (values[vi++] << 25) | (values[vi++] << 16) | 
						(values[vi++] << 7) | (values[vi] >>> 2);
				blocks[bi++] = 
						(values[vi++] << 62) | (values[vi++] << 53) | (values[vi++] << 44) | 
						(values[vi++] << 35) | (values[vi++] << 26) | (values[vi++] << 17) | 
						(values[vi++] << 8) | (values[vi] >>> 1);
				blocks[bi++] = 
						(values[vi++] << 63) | (values[vi++] << 54) | (values[vi++] << 45) | 
						(values[vi++] << 36) | (values[vi++] << 27) | (values[vi++] << 18) | 
						(values[vi++] << 9) | values[vi++];
			}
		}
	}
	...
	static final class Packed64BulkOperation10 extends BulkOperation {
		...
		public void set(long[] blocks, int bi, long[] values, int vi, int iterations) {
			...
			for (int i = 0; i < iterations; ++i) {
				blocks[bi++] = 
						(values[vi++] << 54) | (values[vi++] << 44) | (values[vi++] << 34) | 
						(values[vi++] << 24) | (values[vi++] << 14) | (values[vi++] << 4) | 
						(values[vi] >>> 6);
				blocks[bi++] = 
						(values[vi++] << 58) | (values[vi++] << 48) | (values[vi++] << 38) | 
						(values[vi++] << 28) | (values[vi++] << 18) | (values[vi++] << 8) | 
						(values[vi] >>> 2);
				blocks[bi++] = 
						(values[vi++] << 62) | (values[vi++] << 52) | (values[vi++] << 42) | 
						(values[vi++] << 32) | (values[vi++] << 22) | (values[vi++] << 12) | 
						(values[vi++] << 2) | (values[vi] >>> 8);
				blocks[bi++] = 
						(values[vi++] << 56) | (values[vi++] << 46) | (values[vi++] << 36) | 
						(values[vi++] << 26) | (values[vi++] << 16) | (values[vi++] << 6) | 
						(values[vi] >>> 4);
				blocks[bi++] = 
						(values[vi++] << 60) | (values[vi++] << 50) | (values[vi++] << 40) | 
						(values[vi++] << 30) | (values[vi++] << 20) | (values[vi++] << 10) | 
						values[vi++];
			}
		}
	}
	...
	static final class Packed64BulkOperation11 extends BulkOperation {
		...
		public void set(long[] blocks, int bi, long[] values, int vi, int iterations) {
			...
			for (int i = 0; i < iterations; ++i) {
				blocks[bi++] = 
						(values[vi++] << 53) | (values[vi++] << 42) | (values[vi++] << 31) | 
						(values[vi++] << 20) | (values[vi++] << 9) | (values[vi] >>> 2);
				blocks[bi++] = 
						(values[vi++] << 62) | (values[vi++] << 51) | (values[vi++] << 40) | 
						(values[vi++] << 29) | (values[vi++] << 18) | (values[vi++] << 7) | 
						(values[vi] >>> 4);
				blocks[bi++] = 
						(values[vi++] << 60) | (values[vi++] << 49) | (values[vi++] << 38) | 
						(values[vi++] << 27) | (values[vi++] << 16) | (values[vi++] << 5) | 
						(values[vi] >>> 6);
				blocks[bi++] = 
						(values[vi++] << 58) | (values[vi++] << 47) | (values[vi++] << 36) | 
						(values[vi++] << 25) | (values[vi++] << 14) | (values[vi++] << 3) | 
						(values[vi] >>> 8);
				blocks[bi++] = 
						(values[vi++] << 56) | (values[vi++] << 45) | (values[vi++] << 34) | 
						(values[vi++] << 23) | (values[vi++] << 12) | (values[vi++] << 1) | 
						(values[vi] >>> 10);
				blocks[bi++] = 
						(values[vi++] << 54) | (values[vi++] << 43) | (values[vi++] << 32) | 
						(values[vi++] << 21) | (values[vi++] << 10) | (values[vi] >>> 1);
				blocks[bi++] = 
						(values[vi++] << 63) | (values[vi++] << 52) | (values[vi++] << 41) | 
						(values[vi++] << 30) | (values[vi++] << 19) | (values[vi++] << 8) | 
						(values[vi] >>> 3);
				blocks[bi++] = 
						(values[vi++] << 61) | (values[vi++] << 50) | (values[vi++] << 39) | 
						(values[vi++] << 28) | (values[vi++] << 17) | (values[vi++] << 6) | 
						(values[vi] >>> 5);
				blocks[bi++] = 
						(values[vi++] << 59) | (values[vi++] << 48) | (values[vi++] << 37) | 
						(values[vi++] << 26) | (values[vi++] << 15) | (values[vi++] << 4) | 
						(values[vi] >>> 7);
				blocks[bi++] = 
						(values[vi++] << 57) | (values[vi++] << 46) | (values[vi++] << 35) | 
						(values[vi++] << 24) | (values[vi++] << 13) | (values[vi++] << 2) | 
						(values[vi] >>> 9);
				blocks[bi++] = 
						(values[vi++] << 55) | (values[vi++] << 44) | (values[vi++] << 33) | 
						(values[vi++] << 22) | (values[vi++] << 11) | values[vi++];
			}
		}
	}
	...
	static final class Packed64BulkOperation12 extends BulkOperation {
		...
		public void set(long[] blocks, int bi, long[] values, int vi, int iterations) {
			...
			for (int i = 0; i < iterations; ++i) {
				blocks[bi++] = 
						(values[vi++] << 52) | (values[vi++] << 40) | (values[vi++] << 28) | 
						(values[vi++] << 16) | (values[vi++] << 4) | (values[vi] >>> 8);
				blocks[bi++] = 
						(values[vi++] << 56) | (values[vi++] << 44) | (values[vi++] << 32) | 
						(values[vi++] << 20) | (values[vi++] << 8) | (values[vi] >>> 4);
				blocks[bi++] = 
						(values[vi++] << 60) | (values[vi++] << 48) | (values[vi++] << 36) | 
						(values[vi++] << 24) | (values[vi++] << 12) | values[vi++];
			}
		}
	}
