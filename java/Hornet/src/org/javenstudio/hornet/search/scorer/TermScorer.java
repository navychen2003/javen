...
public final class TermScorer extends Scorer {
	 ...
	 */
	public TermScorer(IWeight weight, IDocsEnum td, IExactSimilarityScorer docScorer) 
			throws IOException {
		super(weight);
	...
	public float getScore() throws IOException {
		...
		return mDocScorer.score(mDocsEnum.getDocID(), mDocsEnum.getFreq());  
	}
