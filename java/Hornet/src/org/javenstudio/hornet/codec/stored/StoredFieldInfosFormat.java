 ...
 *
 */
final class StoredFieldInfosFormat extends FieldInfosFormat {

	private static final String CODEC_NAME = "Lucene40FieldInfos";
	
	static final int FORMAT_START = 0;
	static final int FORMAT_CURRENT = FORMAT_START;
	
	public StoredFieldInfosFormat(IIndexFormat format) { 
		super(format);
	}
	...
	@Override
	public FieldInfosReader createReader(IDirectory dir, String segment) 
			throws IOException { 
		return new StoredFieldInfosReader(this, dir, segment);
	}
	
	@Override
	public FieldInfosWriter createWriter(IDirectory dir, String segment) 
			throws IOException { 
		return new StoredFieldInfosWriter(this, dir, segment);
	}
