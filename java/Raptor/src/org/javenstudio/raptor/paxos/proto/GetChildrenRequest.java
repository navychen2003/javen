...
public class GetChildrenRequest implements WritableComparable<GetChildrenRequest> {
  ...
  public boolean equals(Object to) {
    if (this == to) 
      return true;
    if (!(to instanceof GetChildrenRequest)) 
      return false;
    GetChildrenRequest other = (GetChildrenRequest)to; 
    return StringUtils.stringEquals(path, other.path) && 
           watch == other.watch; 
  }

  public int compareTo(GetChildrenRequest that) {
  ...
  public static GetChildrenRequest read(DataInput in) throws IOException {
    GetChildrenRequest result = new GetChildrenRequest();
