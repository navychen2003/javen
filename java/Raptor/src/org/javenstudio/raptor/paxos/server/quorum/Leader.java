...
public class Leader {
    ...
    Leader(QuorumPeer self,LeaderPaxosServer zk) throws IOException {
        this.self = self;
        try {
    ...
    void lead() throws IOException, InterruptedException {
        ...
        try {
            ...
            zk.getPaxosDatabase().setlastProcessedZxid(zk.getZxid());
            ...
            if (!System.getProperty("paxos.leaderServes", "yes").equals("no")) {
    ...
    static class ToBeAppliedRequestProcessor implements RequestProcessor {
         ...
         * (non-Javadoc)
         * 
         * @see org.javenstudio.raptor.paxos.server.RequestProcessor#processRequest(org.javenstudio.raptor.paxos.server.Request)
         */
         ...
         * (non-Javadoc)
         * 
         * @see org.javenstudio.raptor.paxos.server.RequestProcessor#shutdown()
         */
