...
public class Util {
	...
	public static boolean isValidSnapshot(File f) throws IOException {
        ...
        try {
            ...
            @SuppressWarnings("unused")
			byte a2 = bb.get();
            int len = (int)bb.getShort(); //bb.getInt();
            byte b = bb.get();
            if (len != 1 || b != '/') {
     ...
     * @throws IOException
     */
    public static byte[] readTxnBytes(DataInput in) throws IOException {
        try{
            int size = in.readInt(); 
            byte[] bytes = new byte[size]; //ia.readBuffer("txtEntry");
     ...
     * @throws IOException
     */
    public static byte[] marshallTxnEntry(TxnHeader hdr, Writable txn)
            throws IOException {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        DataOutput bdo = new DataOutputStream(baos); 
     ...
     * @throws IOException
     */
    public static void writeTxnBytes(DataOutput out, byte[] bytes)
            throws IOException {
