...
import org.javenstudio.raptor.paxos.server.persistence.TxnLog.TxnIterator;
...
public class FileTxnSnapLog {
    ...
    public interface PlayBackListener {
        void onTxnLoaded(TxnHeader hdr, Writable rec);
    }
    ...
    private void processTransaction(TxnHeader hdr,DataTree dt,
            Map<Long, Integer> sessions, Writable txn){
        switch (hdr.getType()) {
