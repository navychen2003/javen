...
public class QuorumPeer extends Thread implements QuorumStats.Provider {
    ...
    /* PaxosDatabase is a top level member of quorumpeer 
     * which will be used in all the paxosservers
     * instantiated later. Also, it is created once on 
     * bootup and only thrown away in case of a truncate
     * message from the leader
     */
    private PaxosDatabase zkDb;
    ...
    public QuorumPeer(Map<Long, QuorumServer> quorumPeers, File dataDir,
        ...
        this.zkDb = new PaxosDatabase(this.logFactory);
    ...
    protected Follower makeFollower(FileTxnSnapLog logFactory) throws IOException {
        return new Follower(this, new FollowerPaxosServer(logFactory, 
                this,new PaxosServer.BasicDataTreeBuilder(), this.zkDb));
    }
     
    protected Leader makeLeader(FileTxnSnapLog logFactory) throws IOException {
        return new Leader(this, new LeaderPaxosServer(logFactory,
                this,new PaxosServer.BasicDataTreeBuilder(), this.zkDb));
    }
    
    protected Observer makeObserver(FileTxnSnapLog logFactory) throws IOException {
        return new Observer(this, new ObserverPaxosServer(logFactory,
                this, new PaxosServer.BasicDataTreeBuilder(), this.zkDb));
    }
    ...
    synchronized public PaxosServer getActiveServer(){
        if(leader!=null)
            return leader.zk;
     ...
     * @param database
     */
    public void setPaxosDatabase(PaxosDatabase database) {
        this.zkDb = database;
    }
