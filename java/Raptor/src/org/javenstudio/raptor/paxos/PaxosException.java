...
public abstract class PaxosException extends Exception {
     ...
     * @param path The Paxos path being operated on.
     * @return The specialized exception, presumably to be thrown by
     *  the caller.
     */
    public static PaxosException create(Code code, String path) {
        PaxosException r = create(code);
        r.path = path;
        return r;
    }
     ...
     */
    @Deprecated
    public static PaxosException create(int code, String path) {
        PaxosException r = create(Code.get(code));
        r.path = path;
        return r;
    }
     ...
     */
    @Deprecated
    public static PaxosException create(int code) {
     ...
     * the caller.
     */
    public static PaxosException create(Code code) {
        switch (code) {
            case SYSTEMERROR:
    ...
    /** Codes which represent the various PaxosException
    ...
    public PaxosException(Code code) {
        this.code = code;
    }

    PaxosException(Code code, String path) {
        this.code = code;
        this.path = path;
    }
     ...
     *  @see Code#APIERROR
     */
    public static class APIErrorException extends PaxosException {
     ...
     *  @see Code#AUTHFAILED
     */
    public static class AuthFailedException extends PaxosException {
     ...
     */
    public static class BadArgumentsException extends PaxosException {
     ...
     * @see Code#BADVERSION
     */
    public static class BadVersionException extends PaxosException {
     ...
     */
    public static class ConnectionLossException extends PaxosException {
     ...
     */
    public static class DataInconsistencyException extends PaxosException {
     ...
     * @see Code#INVALIDACL
     */
    public static class InvalidACLException extends PaxosException {
     ...
     */
    public static class InvalidCallbackException extends PaxosException {
     ...
     */
    public static class MarshallingErrorException extends PaxosException {
     ...
     * @see Code#NOAUTH
     */
    public static class NoAuthException extends PaxosException {
     ...
     */
    public static class NoChildrenForEphemeralsException extends PaxosException {
     ...
     * @see Code#NODEEXISTS
     */
    public static class NodeExistsException extends PaxosException {
     ...
     * @see Code#NONODE
     */
    public static class NoNodeException extends PaxosException {
     ...
     * @see Code#NOTEMPTY
     */
    public static class NotEmptyException extends PaxosException {
     ...
     */
    public static class OperationTimeoutException extends PaxosException {
     ...
     */
    public static class RuntimeInconsistencyException extends PaxosException {
     ...
     */
    public static class SessionExpiredException extends PaxosException {
     ...
     */
    public static class SessionMovedException extends PaxosException {
     ...
     */
    public static class SystemErrorException extends PaxosException {
     ...
     */
    public static class UnimplementedException extends PaxosException {
