...
import org.javenstudio.raptor.bigdb.regionserver.wal.LogActionsListener;
...
public class ReplicationSourceManager implements LogActionsListener {
  ...
  private static final Logger LOG =
		  Logger.getLogger(ReplicationSourceManager.class);
   ...
   */
  public ReplicationSourceManager(final ReplicationPaxosWrapper zkHelper,
   ...
   * replication status in paxos. It will also delete older entries.
   ...
   * @return the helper
   */
  public ReplicationPaxosWrapper getRepZkWrapper() {
    return zkHelper;
  }
  ...
  public class OtherRegionServerWatcher implements Watcher {
    ...
    public void process(WatchedEvent watchedEvent) {
      ...
      if (watchedEvent.getType().equals(Event.PaxosState.Expired) ||
          watchedEvent.getType().equals(Event.PaxosState.Disconnected)) {
        return;
      }
