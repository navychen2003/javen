...
public abstract class DBServer {
  ...
  public static final Logger LOG = Logger.getLogger(DBServer.class);

  protected static final ThreadLocal<DBServer> SERVER =
    new ThreadLocal<DBServer>();
  ...
  protected DBRPCMetrics  rpcMetrics;
  ...
  protected DBRPCErrorHandler errorHandler = null;
    ...
    public int readAndProcess() throws IOException, InterruptedException {
      while (true) {
        ...
        if (data == null) {
          ...
          if (dataLength == DBClient.PING_CALL_ID) {
            dataLengthBuffer.clear();
  ...
  protected DBServer(String bindAddress, int port,
  ...
  protected DBServer(String bindAddress, int port,
    ...
    this.rpcMetrics = new DBRPCMetrics(serverName,
   ...
   */
  public void setErrorHandler(DBRPCErrorHandler handler) {
