 ...
 *
 * <p>This is the org.javenstudio.raptor.ipc.Client renamed as DBClient and
...
public class DBClient {
  ...
  private static final Logger LOG = Logger.getLogger(DBClient.class);
  ...
  private class Connection extends Thread {
    ...
    private void writeHeader() throws IOException {
      out.write(DBServer.HEADER.array());
      out.write(DBServer.CURRENT_VERSION);
   ...
   */
  public DBClient(Class<? extends Writable> valueClass, Configuration conf,
      SocketFactory factory) {
    this.valueClass = valueClass;
    this.maxIdleTime =
      conf.getInt("bigdb.ipc.client.connection.maxidletime", 10000); //10s
    this.maxRetries = conf.getInt("bigdb.ipc.client.connect.max.retries", 0);
    this.failureSleep = conf.getInt("bigdb.client.pause", 2000);
    this.tcpNoDelay = conf.getBoolean("bigdb.ipc.client.tcpnodelay", false);
    this.tcpKeepAlive = conf.getBoolean("bigdb.ipc.client.tcpkeepalive", true);
