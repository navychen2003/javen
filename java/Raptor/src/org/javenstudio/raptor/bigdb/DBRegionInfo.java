...
import org.javenstudio.raptor.bigdb.util.JenkinsHash;
import org.javenstudio.raptor.bigdb.util.MD5Hash;
 ...
 */
public class DBRegionInfo extends VersionedWritable implements WritableComparable<DBRegionInfo>{
  ...
  private byte [] endKey = DBConstants.EMPTY_BYTE_ARRAY;
  private boolean offLine = false;
  private long regionId = -1;
  private transient byte [] regionName = DBConstants.EMPTY_BYTE_ARRAY;
  private String regionNameStr = "";
  private boolean split = false;
  private byte [] startKey = DBConstants.EMPTY_BYTE_ARRAY;
  protected DBTableDescriptor tableDesc = null;
   ...
   * first meta regions
   */
  private DBRegionInfo(long regionId, DBTableDescriptor tableDesc) {
    super();
  ...
  public DBRegionInfo() {
    super();
    this.tableDesc = new DBTableDescriptor();
  }
   ...
   */
  public DBRegionInfo(final DBTableDescriptor tableDesc, final byte [] startKey,
      final byte [] endKey)
  throws IllegalArgumentException {
   ...
   * @throws IllegalArgumentException
   */
  public DBRegionInfo(DBTableDescriptor tableDesc, final byte [] startKey,
  ...
  throws IllegalArgumentException {
    ...
    this.regionNameStr = Bytes.toStringBinary(this.regionName);
    this.split = split;
    this.endKey = endKey == null? DBConstants.EMPTY_END_ROW: endKey.clone();
    this.startKey = startKey == null?
      DBConstants.EMPTY_START_ROW: startKey.clone();
    this.tableDesc = tableDesc;
    setHashCode();
  }
  ...
  public String toString() {
    return "REGION => {" + DBConstants.NAME + " => '" +
      this.regionNameStr +
      "', STARTKEY => '" +
