...
class ShutdownHook {
   ...
   */
  public static final String RUN_SHUTDOWN_HOOK = "bigdb.shutdown.hook";

  /**
   * Key for a long configuration on how much time to wait on the fs shutdown
   * hook. Default is 30 seconds.
   */
  public static final String FS_SHUTDOWN_HOOK_WAIT = "bigdb.fs.shutdown.hook.wait";
   ...
   * Pass '-Dbigdb.shutdown.hook=false' to test turning off the running of
   * shutdown hooks.
   * @param args
   * @throws IOException
   */
