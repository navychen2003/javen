 ...
 */
public class DBServerLoad implements WritableComparable<DBServerLoad> {
  /** number of regions */
    // could just use regionLoad.size() but master.RegionManager likes to play
    // around with this value while passing DBServerLoad objects around during
   ...
   * @param maxHeapMB
   */
  public DBServerLoad(final int numberOfRequests, final int usedHeapMB,
      final int maxHeapMB) {
  ...
  /**
   * Constructor
   * @param hsl the template DBServerLoad
   */
  public DBServerLoad(final DBServerLoad hsl) {
  ...
  public boolean equals(Object o) {
    ...
    return compareTo((DBServerLoad)o) == 0;
  }
  ...
  /**
   * @param load Instance of DBServerLoad
   */
  public void addRegionInfo(final DBServerLoad.RegionLoad load) {
  ...
  public void addRegionInfo(final byte[] name, final int stores,
      final int storefiles, final int storefileSizeMB,
      final int memstoreSizeMB, final int storefileIndexSizeMB) {
    this.regionLoad.add(new DBServerLoad.RegionLoad(name, stores, storefiles,
  ...
  public int compareTo(DBServerLoad o) {
