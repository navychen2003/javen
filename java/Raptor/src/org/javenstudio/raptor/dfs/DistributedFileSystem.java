...
import org.javenstudio.raptor.dfs.DFSClient.DFSOutputStream;
...
public class DistributedFileSystem extends FileSystem {
  ...
  public void initialize(URI uri, Configuration conf) throws IOException {
    ...
    if (host == null) {
      throw new IOException("Incomplete DFS URI, no host: "+ uri);
    }
  ...
  private FileStatus makeQualified(FileStatus f) {
    return new FileStatus(f.getLen(), f.isDir(), f.isHidden(), f.getReplication(),
   ...
   *  
   * @see org.javenstudio.raptor.dfs.protocol.ClientProtocol#setSafeMode(
