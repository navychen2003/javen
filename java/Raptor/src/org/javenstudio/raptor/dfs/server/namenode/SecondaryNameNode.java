...
import org.javenstudio.raptor.dfs.server.common.InconsistentFSStateException;
...
public class SecondaryNameNode implements Runnable {
  ...
  public static final Logger LOG = 
		  Logger.getLogger(SecondaryNameNode.class);
...
private void initialize(Configuration conf) throws IOException {
  ...
  private String getInfoServer() throws IOException {
    ...
    if (!"dfs".equals(fsName.getScheme())) {
  ...
  public static void main(String[] argv) throws Exception {
    ...
    Configuration tconf = ConfigurationFactory.create(true);
    if (argv.length >= 1) {
  ...
  static class CheckpointStorage extends FSImage {
    ...
    void recoverCreate(Collection<File> dataDirs,
      ...
      for (Iterator<StorageDirectory> it = 
        ...
        try {
          curState = sd.analyzeStorage(DfsConstants.StartupOption.REGULAR);
