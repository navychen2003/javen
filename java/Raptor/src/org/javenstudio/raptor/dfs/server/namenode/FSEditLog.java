...
import org.javenstudio.raptor.dfs.server.common.Storage.StorageDirectory;
import org.javenstudio.raptor.dfs.server.namenode.FSImage.NameNodeDirType;
...
public class FSEditLog {
 ...
 for (Iterator<StorageDirectory> it = 
  ...
  private void printStatistics(boolean force) {
    ...
    FSNamesystem.LOG.info(buf.toString());
  }
