...
import org.javenstudio.raptor.dfs.server.namenode.BlocksMap.BlockInfo;
import org.javenstudio.raptor.dfs.server.namenode.metrics.FSNamesystemMBean;
import org.javenstudio.raptor.dfs.server.namenode.metrics.FSNamesystemMetrics;
import org.javenstudio.raptor.security.AccessControlException;
...
import org.javenstudio.raptor.net.CachedDNSToSwitchMapping;
import org.javenstudio.raptor.net.DNSToSwitchMapping;
import org.javenstudio.raptor.net.NetworkTopology;
import org.javenstudio.raptor.net.ScriptBasedMapping;
import org.javenstudio.raptor.dfs.server.namenode.LeaseManager.Lease;
import org.javenstudio.raptor.dfs.server.namenode.UnderReplicatedBlocks.BlockIterator;
import org.javenstudio.raptor.dfs.server.protocol.BlocksWithLocations;
import org.javenstudio.raptor.dfs.server.protocol.BlocksWithLocations.BlockWithLocations;
...
public class FSNamesystem implements FSConstants, FSNamesystemMBean {
  public static final Logger LOG = Logger.getLogger(FSNamesystem.class);
  ...
  public static final Logger auditLog = LOG; //Logger.getLogger(
  ...
  public static Collection<File> getNamespaceDirs(Configuration conf) {
    ...
    //if (dirNames.isEmpty())
    //  dirNames.add("/tmp/raptor/dfs/name");
  ...
  public static Collection<File> getNamespaceEditsDirs(Configuration conf) {
    ...
    //  editsDirNames.add("/tmp/raptor/dfs/name");
  ...
  synchronized void metaSave(String filename) throws IOException {
    ...
    File file = new File(System.getProperty("hawk.log.dir"), 
                         filename);
  ...
  public synchronized void setTimes(String src, long mtime, long atime) throws IOException {
    if (!isAccessTimeSupported() && atime != -1) {
      throw new IOException("Access time for dfs is not configured. " +
  ...
  LocatedBlock appendFile(String src, String holder, String clientMachine
    ...
    if (supportAppends == false) {
      throw new IOException("Append to dfs not supported." +
   ...
   * 
   * @see org.javenstudio.raptor.dfs.server.datanode.DataNode#register()
   */
  public synchronized void registerDatanode(DatanodeRegistration nodeReg
                                            ) throws IOException {
    String dnAddress = Server.getRemoteAddress();
    if (dnAddress == null || "127.0.0.1".equals(dnAddress)) {
  ...
  @Deprecated
  public InetSocketAddress getDFSNameNodeHttpAddress() {
    return nameNode.getHttpAddress(); 
  }
  ...
  class SafeModeInfo {
    ...
    String getTurnOffTip() {
      ...
      if(isManual()) {
        ...
        leaveMsg = "Use \"hawk dfsadmin -safemode leave\" to turn safe mode off";
      }
      if(blockTotal < 0)
        return leaveMsg + ".";
   ...
   *        "raptor:service=NameNode,name=FSNamesystemState"
   */
