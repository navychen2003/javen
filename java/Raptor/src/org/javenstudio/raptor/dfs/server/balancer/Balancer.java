package org.javenstudio.raptor.dfs.server.balancer;
...
import org.javenstudio.raptor.dfs.server.common.Util;
...
public class Balancer implements Tool {
  private static final Logger LOG = Logger.getLogger(Balancer.class);
    ...
    private void dispatch() {
      ...
      try {
        sock.connect(NetUtils.createSocketAddr(
            target.datanode.getName()), DfsConstants.READ_TIMEOUT);
