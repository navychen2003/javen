...
import org.javenstudio.raptor.dfs.server.datanode.FSDatasetInterface.MetaDataInputStream;
...
import static org.javenstudio.raptor.dfs.server.datanode.DataNode.DN_CLIENTTRACE_FORMAT;
      ...
      if (targets.length > 0) {
        ...
        try {
          ...
          int writeTimeout = datanode.socketWriteTimeout + 
                             (DfsConstants.WRITE_TIMEOUT_EXTENSION * numTargets);
