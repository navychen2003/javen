...
/**
 * Interface supported by {@link org.javenstudio.raptor.io.WritableComparable}
...
public abstract class BinaryComparable implements Comparable<BinaryComparable> {
   ...
   * @see org.javenstudio.raptor.io.WritableComparator#compareBytes(byte[],int,int,byte[],int,int)
   */
   ...
   * @see org.javenstudio.raptor.io.WritableComparator#hashBytes(byte[],int)
   */
  public int hashCode() {
