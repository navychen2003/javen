...
import org.javenstudio.raptor.io.compress.zlib.ZlibFactory;
import org.javenstudio.raptor.io.serializer.Deserializer;
import org.javenstudio.raptor.io.serializer.SerializationFactory;
import org.javenstudio.raptor.io.serializer.Serializer;
import org.javenstudio.raptor.conf.*;
import org.javenstudio.raptor.util.Progressable;
import org.javenstudio.raptor.util.Progress;
import org.javenstudio.raptor.util.ReflectionUtils;
import org.javenstudio.raptor.util.NativeCodeLoader;
import org.javenstudio.raptor.util.MergeSort;
import org.javenstudio.raptor.util.PriorityQueue;
...
public class SequenceFile {
   ...
   * @deprecated Use 
   *             {@link SequenceFileOutputFormat#getOutputCompressionType(JobConf)} 
   ...
   *             {@link SequenceFileOutputFormat#setOutputCompressionType(JobConf, SequenceFile.CompressionType)}
  ...
  public static Writer
    ...
    if ((codec instanceof GzipCodec) &&
      ...
      throw new IllegalArgumentException("SequenceFile doesn't work with " +
                                         "GzipCodec without native-raptor code!");
    }
