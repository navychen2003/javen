...
import org.javenstudio.raptor.util.LineReader;
...
public class HarFileSystem extends FilterFileSystem {
   ...
   * (non-Javadoc)
   * @see org.javenstudio.raptor.fs.FilterFileSystem#makeQualified(
   * org.javenstudio.raptor.fs.Path)
   */
  @Override
  ...
  public FileStatus getFileStatus(Path f) throws IOException {
    ...
    return new FileStatus(hstatus.isDir()?0:hstatus.getLength(), hstatus.isDir(), false,
