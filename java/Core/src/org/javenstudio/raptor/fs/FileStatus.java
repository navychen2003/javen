...
public class FileStatus implements Writable, Comparable<Object> {
  ...
  public FileStatus() { this(0, false, false, 0, 0, 0, 0, null, null, null, null); }
  
  //We should deprecate this soon?
  public FileStatus(long length, boolean isdir, boolean ishidden, int block_replication,
                    long blocksize, long modification_time, Path path) {

    this(length, isdir, ishidden, block_replication, blocksize, modification_time,
  ...
  public int compareTo(Object o) {
	if (o == null || !(o instanceof FileStatus)) return -1;
