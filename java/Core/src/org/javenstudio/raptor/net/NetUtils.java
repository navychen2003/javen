...
public class NetUtils {
   ...
   * <tt>raptor.rpc.socket.factory.class.&lt;ClassName&gt;</tt>. When no
   * such parameter exists then fall back on the default socket factory as
   * configured by <tt>raptor.rpc.socket.factory.class.default</tt>. If
  ...
  public static SocketFactory getSocketFactory(Configuration conf,
    ...
    String propValue =
        conf.get("rpc.socket.factory.class." + clazz.getSimpleName());
   ...
   * parameter <tt>raptor.rpc.socket.factory.default</tt>
   * 
   * @param conf the configuration
  ...
  public static SocketFactory getDefaultSocketFactory(Configuration conf) {
    ...
    String propValue = conf.get("rpc.socket.factory.class.default");
    if ((propValue == null) || (propValue.length() == 0))
  ...
  public static String getServerAddress(Configuration conf,
    ...
    String oldAddr = conf != null ? conf.get(oldBindAddressName) : oldBindAddressName;
    String oldPort = conf != null ? conf.get(oldPortName) : oldPortName;
    String newAddrPort = conf != null ? conf.get(newBindAddressName) : newBindAddressName;
  ...
  public static String getServerAddress(String bindAddress) {
    return getServerAddress(null, null, null, bindAddress); 
  }
