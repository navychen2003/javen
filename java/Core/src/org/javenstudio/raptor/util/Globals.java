...
public final class Globals {
    ...
    public static final String ALT_DD_ATTR = 
        "org.javenstudio.raptor.util.deploy.alt_dd";
    ...
    public static final String CLASS_LOADER_ATTR =
        "org.javenstudio.raptor.util.classloader";

    /**
     * Request dispatcher state.
     */
    public static final String DISPATCHER_TYPE_ATTR = 
        "org.javenstudio.raptor.util.core.DISPATCHER_TYPE";

    /**
     * Request dispatcher path.
     */
    public static final String DISPATCHER_REQUEST_PATH_ATTR = 
        "org.javenstudio.raptor.util.core.DISPATCHER_REQUEST_PATH";
    ...
    public static final String RESOURCES_ATTR =
        "org.javenstudio.raptor.util.resources";
    ...
    public static final String CLASS_PATH_ATTR =
        "org.javenstudio.raptor.util.jsp_classpath";
    ...
    public static final String INVOKED_ATTR =
        "org.javenstudio.raptor.util.INVOKED";
    ...
    public static final String JSP_FILE_ATTR =
        "org.javenstudio.raptor.util.jsp_file";
    ...
    public static final String MBEAN_REGISTRY_ATTR =
        "org.javenstudio.raptor.util.Registry";
    ...
    public static final String MBEAN_SERVER_ATTR =
        "org.javenstudio.raptor.util.MBeanServer";
    ...
    public static final String NAMED_DISPATCHER_ATTR =
        "org.javenstudio.raptor.util.NAMED";
     ...
     */
     public static final String SSI_FLAG_ATTR =
         "org.javenstudio.raptor.util.ssi.SSIServlet";
    ...
    public static final String WELCOME_FILES_ATTR =
        "org.javenstudio.raptor.util.WELCOME_FILES";
    ...
    public static final boolean STRICT_SERVLET_COMPLIANCE =
        Boolean.valueOf(System.getProperty("org.javenstudio.raptor.util.STRICT_SERVLET_COMPLIANCE", "false")).booleanValue();
