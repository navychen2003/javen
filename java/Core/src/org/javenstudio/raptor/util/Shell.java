...
abstract public class Shell {
   ...
   * process from within the {@link org.javenstudio.raptor.mapred.Mapper} or the 
   * {@link org.javenstudio.raptor.mapred.Reducer} implementations 
   * e.g. <a href="{@docRoot}/org.javenstudio.raptor/mapred/pipes/package-summary.html">Hadoop Pipes</a> 
   * or <a href="{@docRoot}/org.javenstudio.raptor/streaming/package-summary.html">Hadoop Streaming</a>.
   * 
  ...
  private void runCommand() throws IOException { 
	String[] execString = getExecString();
	if (execString == null) {
	  if (DEBUG && LOG.isDebugEnabled())
		  LOG.debug("runCommand: " + getClass().getName() + " has null execString");
