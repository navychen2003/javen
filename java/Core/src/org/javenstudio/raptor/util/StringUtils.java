...
public class StringUtils {
  ...
  public static void startupShutdownMessage(Class<?> clazz, String[] args,
                                     final Logger LOG) {
    final String hostname = getHostname(); //DNS.getMachineName(); //
    ...
    LOG.info(
        toStartupShutdownString(" STARTUP_MSG: ", new String[] {
            ...
            "  build = compiled by '" + VersionInfo.getUser()
    ...
    Runtime.getRuntime().addShutdownHook(new Thread() {
      public void run() {
        LOG.info(toStartupShutdownString(" SHUTDOWN_MSG: ", new String[]{
          "Shutting down " + simplename + " at " + hostname}));
      }
    });
  }
  ...
  //  return ParseUtils.formatDate(tm); 
  //}
  ...
  //  return ParseUtils.htmlEncode(str); 
  //}

  //public static String CDATAEncode(String str) {
  //  return ParseUtils.CDATAEncode(str); 
  //}
  ...
  public static String getCharacterEncoding() {
    if (encodingDefault == null) {
      synchronized (encodingAliases) {
        encodingDefault = getCharacterEncoding(VersionInfo.getCharacterEncoding());
      }
    }
  ...
  public static Locale getLocale() {
    if (localeDefault == null) {
      synchronized (encodingAliases) {
        localeDefault = StringManager.createLocale(getLocaleString());
      }
    }
  ...
  public static String getLocaleString() {
    return VersionInfo.getLocaleString(); 
  }
