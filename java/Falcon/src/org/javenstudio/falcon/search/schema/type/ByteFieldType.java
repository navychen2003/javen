...
import org.javenstudio.hornet.query.source.ByteFieldSource;
 ...
 * @see Byte
 */
public class ByteFieldType extends PrimitiveFieldType {
	...
	public SortField getSortField(SchemaField field, boolean reverse) 
		...
		return new AdvancedSortField(field.getName(), SortField.Type.BYTE, reverse);
	}
	...
	public ValueSource getValueSource(SchemaField field, QueryBuilder qparser) 
		...
		return new ByteFieldSource(field.getName());
	}
	...
	@Override
	public Byte toObject(Fieldable f) throws ErrorException {
