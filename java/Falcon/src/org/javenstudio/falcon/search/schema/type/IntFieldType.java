 ...
 * @see TrieIntField
 */
public class IntFieldType extends PrimitiveFieldType {
	...
	public SortField getSortField(SchemaField field,boolean reverse) 
		...
		return new AdvancedSortField(field.getName(), SortField.Type.INT, reverse);
	}
	...
	@Override
	public Integer toObject(Fieldable f) throws ErrorException {
