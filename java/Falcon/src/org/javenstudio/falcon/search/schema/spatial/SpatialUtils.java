...
public class SpatialUtils {
   ...
   * return a String array of length <i>dimension</i>
   * containing the values.
   *
   * @param out         A preallocated array.  Must be size dimension.  
   * If it is not it will be resized.
   * @param externalVal The value to parse
   * @param dimension   The expected number of values for the point
   * @return An array of the values that make up the point (aka vector)
   * @throws com.spatial4j.core.exception.InvalidShapeException if the dimension specified 
   * does not match the number of values in the externalValue.
   */
  ...
  /**
   * Given a string containing <i>dimension</i> values encoded in it, separated by commas, 
   * return a double array of length <i>dimension</i>
   * containing the values.
   *
