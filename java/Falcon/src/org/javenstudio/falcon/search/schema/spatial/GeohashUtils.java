...
public class GeohashUtils {
  ...
  //sparse array of indexes from '0' to 'z'
   ...
   */
  public static Point decode(String geohash, SpatialContext ctx) throws InvalidShapeException {
  ...
  public static Rectangle decodeBoundary(String geohash, SpatialContext ctx) throws InvalidShapeException {
