...
public class SpatialContext {
  ...
  public void verifyX(double x) throws InvalidShapeException {
  ...
  /** Ensure fits in {@link #getWorldBounds()} */
  public void verifyY(double y) throws InvalidShapeException {
    Rectangle bounds = getWorldBounds();
  ...
  /** Construct a point. */
  public Point makePoint(double x, double y) throws InvalidShapeException {
    verifyX(x);
    verifyY(y);
  ...
  public Rectangle makeRectangle(Point lowerLeft, Point upperRight) throws InvalidShapeException {
  ...
  public Circle makeCircle(double x, double y, double distance) throws InvalidShapeException {
    return makeCircle(makePoint(x, y), distance);
  }

  /** Construct a circle. The units of "distance" should be the same as x & y. */
  public Circle makeCircle(Point point, double distance) throws InvalidShapeException {
    if (distance < 0)
