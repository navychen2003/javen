...
public class SpatialContextFactory {
   ...
   *                    argument.
   */
  public static SpatialContext makeSpatialContext(Map<String,String> args, 
		  ClassLoader classLoader) throws InvalidShapeException {
  ...
  protected void init(Map<String, String> args, ClassLoader classLoader) throws InvalidShapeException {
    this.args = args;
  ...
  protected void initWorldBounds() throws InvalidShapeException {
