...
public class GeoCircle extends CircleImpl {
  ...
  public GeoCircle(Point p, double radiusDEG, SpatialContext ctx) throws InvalidShapeException {
  ...
  @Override
  public void reset(double x, double y, double radiusDEG) throws InvalidShapeException {
    super.reset(x, y, radiusDEG);
    init();
  }

  private void init() throws InvalidShapeException {
    if (radiusDEG > 90) {
