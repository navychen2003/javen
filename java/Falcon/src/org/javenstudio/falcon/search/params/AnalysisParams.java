...
public interface AnalysisParams {
  ...
  /**
   * Set to {@code true} to indicate that the index tokens 
   * that match query tokens should be marked as "mateched".
   */
  ...
  /**
   * Holds a comma-separated list of field types that 
   * the analysis should be peformed for.
   */
  static final String FIELD_TYPE = PREFIX + ".fieldtype";

  /**
   * Hodls a comma-separated list of field named that 
   * the analysis should be performed for.
   */
