...
/**
 * <code>DocList</code> represents the result of a query: 
 * an ordered list of document ids with optional score.
 * This list contains a subset of the complete list of documents 
 * actually matched: <code>size()</code>
...
public interface DocList extends DocSet {
	...
	/**
	 * Returns the zero based offset of this list within 
	 * the total ordered list of matches to the query.
	 */
	public int offset();
