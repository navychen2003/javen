...
/**
 * <code>DocSet</code> represents an unordered set of Document Ids.
 *
 * <p>
 * WARNING: Any DocSet returned from Searcher should <b>not</b> 
 * be modified as it may have been retrieved from
...
public interface DocSet /* extends Collection<Integer> */ {
	 ...
	 *
	 * @see #addUnique
	 * @throws ErrorException if the implementation does not allow modifications
	 */
	 ...
	 * a Searcher method, it's not safe to modify the BitSet.
	 *
	 * @return
	 ...
	 * Neither set is modified - a new DocSet is
	...
	/**
	 * Returns a Filter for use in search methods, assuming this DocSet
	 * was generated from the top-level MultiReader that the search
	 * methods will be invoked with.
	 */
	public IFilter getTopFilter();

	/**
	 * Takes the docs from this set and sets those bits on the target OpenBitSet.
	 * The target should be sized large enough to accommodate all of the documents 
