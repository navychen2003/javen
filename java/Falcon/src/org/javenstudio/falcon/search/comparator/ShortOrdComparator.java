...
public class ShortOrdComparator extends PerSegmentComparator {
	
    private final short[] mReaderOrds;

    public ShortOrdComparator(short[] readerOrds, TermOrdValComparator parent) {
    	super(parent);
    ...
    public int compareBottom(int doc) {
    	...
    	int order = mReaderOrds[doc]&0xFFFF;
    	if (order == 0) 
    ...
    public void copy(int slot, int doc) {
    	int ord = mReaderOrds[doc]&0xFFFF;
    	if (ord == 0) {
