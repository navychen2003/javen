...
public interface EventListener {
	 ...
	 * <p/>
	 * Implementations should add the {@link EventParams#EVENT} 
     ...
     * @param currentSearcher The existing {@link LigntningIndexSearcher}. 
     * null if this is a firstSearcher event.
     */
	public void newSearcher(Searcher newSearcher, 
