...
public class TaskQueue {
	...
	public final boolean post(PriorityRunnable r) throws InterruptedException {
		return false; //mThread.getHandler().post(getPostRunnable(r)); 
	}
	
	public final boolean postAfter(PriorityRunnable r, PriorityRunnable after) throws InterruptedException {
		if (after != null) 
	...
	public final boolean postAtTime(PriorityRunnable r, long uptimeMillis) throws InterruptedException {
		return false; //mThread.getHandler().postAtTime(getPostRunnable(r), uptimeMillis); 
	}
	
	public final boolean postDelayed(PriorityRunnable r, long delayMillis) throws InterruptedException {
		return false; //mThread.getHandler().postDelayed(getPostRunnable(r), delayMillis); 
	}
