...
public class StrHelper {
   ...
   */
  public static boolean parseBool(String s) throws ErrorException {
    if( s != null ) {
    ...
    throw new ErrorException(ErrorException.ErrorCode.BAD_REQUEST, "invalid boolean value: "+s );
  }

  /**
   * {@link NullPointerException} and {@link ErrorException} free version of {@link #parseBool(String)}
