...
public final class TimeZoneUtils {
   ...
   * </ul>
   * 
   * @param ID Either a TimeZone ID found in KNOWN_TIMEZONE_IDS, 
   * or a "CustomID" specified as a GMT offset.
   * @return A TimeZone object corresponding to the input, 
   * or null if no such TimeZone is supported.
