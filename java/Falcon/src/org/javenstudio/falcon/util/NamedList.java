 ...
 * If access by key is more important for serialization, see {@link NamedMap},
 * or simply use a regular {@link Map}
 * </p>
 *
 *
 */
public class NamedList<T> implements Iterable<Map.Entry<String,T>>, Cloneable, Serializable, INamedValues<T> {
  private static final long serialVersionUID = 1L;
	
  public static final NamedList<?> EMPTY = new NamedList<Object>();
   ...
   * the NamedList (in future versions), but this is not guaranteed and should
