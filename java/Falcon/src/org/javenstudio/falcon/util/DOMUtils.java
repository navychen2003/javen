...
public class DOMUtils {
  ...
  public static String getAttr(NamedNodeMap attrs, String name) throws ErrorException {
    return getAttr(attrs,name,null);
  }

  public static String getAttr(Node nd, String name) throws ErrorException {
    return getAttr(nd.getAttributes(), name);
  }

  public static String getAttr(NamedNodeMap attrs, String name, String missing_err) throws ErrorException {
    Node attr = attrs==null? null : attrs.getNamedItem(name);
    if (attr==null) {
      if (missing_err==null) return null;
      throw new ErrorException(ErrorException.ErrorCode.SERVER_ERROR,
    		  missing_err + ": missing mandatory attribute '" + name + "'");
    }
    String val = attr.getNodeValue();
    return val;
  }

  public static String getAttr(Node node, String name, String missing_err) throws ErrorException {
    return getAttr(node.getAttributes(), name, missing_err);
  }

  //////////////////////////////////////////////////////////
  // Routines to parse XML in the syntax of the query
  // response schema.
  // Should these be moved to Config?  Should all of these things?
  //////////////////////////////////////////////////////////
  public static NamedList<Object> childNodesToNamedList(Node nd) throws ErrorException {
    return nodesToNamedList(nd.getChildNodes());
  }

  @SuppressWarnings("rawtypes")
  public static List childNodesToList(Node nd) throws ErrorException {
    return nodesToList(nd.getChildNodes());
  }

  public static NamedList<Object> nodesToNamedList(NodeList nlst) throws ErrorException {
  ...
  @SuppressWarnings("rawtypes")
  public static List nodesToList(NodeList nlst) throws ErrorException {
  ...
  public static void addToNamedList(Node nd, NamedList nlst, List arr) throws ErrorException {
  ...
  public static void setText(Node nd, String val) {
	if (nd == null || val == null) return;
   ...
   */
  public static void substituteSystemProperties(Node node) throws ErrorException {
   ...
   */
  public static void substituteProperties(Node node, Properties properties) throws ErrorException {
   ...
   */
  public static String substituteProperty(String value, Properties coreProperties) throws ErrorException {
    ...
    while (i.hasNext()) {
      ...
      if (fragment == null) {
        ...
        if (fragment == null) {
          throw new ErrorException( ErrorException.ErrorCode.SERVER_ERROR, "No system property or default value specified for " + propertyName + " value:" + value);
        }
      }
      sb.append(fragment);
    }
