...
public interface CommonParams {
  ...
  /** 
   * the Request Handler (formerly known as the Query Type) 
   * - which Request Handler should handle the request 
   */
  ...
  /** query string(s) for filtering the results without affecting scoring */
  ...
  /** 
   * whether to include debug data for all components pieces, 
   * including doing explains
   */
  ...
  /**
   * {@link #DEBUG} value indicating an interest in debug output 
   * related to timing
   */
  ...
  /**
   * {@link #DEBUG} value indicating an interest in debug output 
   * related to the results (explains)
   */
  public static final String RESULTS = "results";
  
  /**
   * {@link #DEBUG} value indicating an interest in debug output 
   * related to the Query (parsing, etc.)
   */
   ...
   * If not set, or the value is <= 0, there is no timeout.
   */
   ...
   * cache=false means don't check any query or filter caches.
   ...
   * smallest cost to largest. If cost>=100 and the query implements PostFilter, 
