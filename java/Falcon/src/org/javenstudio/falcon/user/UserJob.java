...
public class UserJob implements Job<Void>, JobCancelListener {
	...
	public static interface Task { 
		...
		public void process(UserJob job, JobContext jc) 
	...
	public UserJob(UserManager manager) { 
