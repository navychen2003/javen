...
/**
 * DBConstants holds a bunch of bigdb-related constants
 */
public final class DBConstants {
  ...
  public static final String VERSION_FILE_NAME = "bigdb.version";
   ...
   * Version 7 introduces hfile -- bigdb 0.19 to 0.20..
   */
  ...
  //TODO: Is having bigdb homed on port 60k OK?

  /** Cluster is in distributed mode or not */
  public static final String CLUSTER_DISTRIBUTED = "bigdb.cluster.distributed";
  ...
  public static final String MASTER_PORT = "bigdb.master.port";

  /** default port that the master listens on */
  public static final int DEFAULT_MASTER_PORT = 10060;

  /** default port for master web api */
  public static final int DEFAULT_MASTER_INFOPORT = 10061;

  /** Parameter name for the master type being backup (waits for primary to go inactive). */
  public static final String MASTER_TYPE_BACKUP = "bigdb.master.backup";

  /** by default every master is a possible primary master unless the conf explicitly overrides it */
  public static final boolean DEFAULT_MASTER_TYPE_BACKUP = false;

  /** Name of Paxos quorum configuration parameter. */
  public static final String PAXOS_QUORUM = "bigdb.paxos.quorum";

  /** Name of Paxos config file in conf/ directory. */
  public static final String PAXOS_CONFIG_NAME = "paxos.conf";

  /** Parameter name for number of times to retry writes to Paxos. */
  public static final String PAXOS_RETRIES = "paxos.retries";
  /** Default number of times to retry writes to Paxos. */
  public static final int DEFAULT_PAXOS_RETRIES = 5;

  /** Parameter name for Paxos pause between retries. In milliseconds. */
  public static final String PAXOS_PAUSE = "paxos.pause";
  /** Default Paxos pause value. In milliseconds. */
  public static final int DEFAULT_PAXOS_PAUSE = 2 * 1000;

  /** default client port that the paxos listens on */
  public static final int DEFAULT_PAXOS_CLIENT_PORT = 10021;

  /** Parameter name for the root dir in ZK for this cluster */
  public static final String PAXOS_ZNODE_PARENT = "paxos.znode.parent";

  public static final String DEFAULT_PAXOS_ZNODE_PARENT = "/bigdb";

  /** Parameter name for port region server listens on. */
  public static final String REGIONSERVER_PORT = "bigdb.regionserver.port";

  /** Default port region server listens on. */
  public static final int DEFAULT_REGIONSERVER_PORT = 10062;

  /** default port for region server web api */
  public static final int DEFAULT_REGIONSERVER_INFOPORT = 10063;

  /** Parameter name for what region server interface to use. */
  public static final String REGION_SERVER_CLASS = "bigdb.regionserver.class";

  /** Parameter name for what region server implementation to use. */
  public static final String REGION_SERVER_IMPL= "bigdb.regionserver.impl";

  /** Default region server interface class name. */
  //public static final String DEFAULT_REGION_SERVER_CLASS = DBRegionInterface.class.getName();

  /** Parameter name for how often threads should wake up */
  public static final String THREAD_WAKE_FREQUENCY = "bigdb.server.thread.wakefrequency";

  /** Parameter name for how often a region should should perform a major compaction */
  public static final String MAJOR_COMPACTION_PERIOD = "bigdb.dbregion.majorcompaction";

  /** Parameter name for bigdb instance root directory */
  public static final String BIGDB_DIR = "bigdb.rootdir";

  /** Used to construct the name of the log directory for a region server
   * Use '.' as a special character to seperate the log files from table data */
  public static final String DBREGION_LOGDIR_NAME = ".logs";

  /** Like the previous, but for old logs that are about to be deleted */
  public static final String DBREGION_OLDLOGDIR_NAME = ".oldlogs";

  /** Used to construct the name of the compaction directory during compaction */
  public static final String DBREGION_COMPACTIONDIR_NAME = "compaction.dir";
...
//  public static final int FOREVER = -1;
  ...
  //TODO: BIGDB_CLIENT_RETRIES_NUMBER_KEY is only used by TestMigrate. Move it
  //      there.
  public static final String BIGDB_CLIENT_RETRIES_NUMBER_KEY =
    "bigdb.client.retries.number";
  ...
  public static final String REGION_IMPL = "bigdb.dbregion.impl";
  ...
  public static final byte DEFAULT_CLUSTER_ID = 0;
     ...
     */
  public static String BIGDB_CLIENT_SCANNER_MAX_RESULT_SIZE_KEY = "bigdb.client.scanner.max.result.size";
   ...
   */
  public static long DEFAULT_BIGDB_CLIENT_SCANNER_MAX_RESULT_SIZE = Long.MAX_VALUE;
   ...
   */
  public static String BIGDB_REGIONSERVER_LEASE_PERIOD_KEY   = "bigdb.regionserver.lease.period";


  /**
   * Default value of {@link #BIGDB_REGIONSERVER_LEASE_PERIOD_KEY}.
   */
  public static long DEFAULT_BIGDB_REGIONSERVER_LEASE_PERIOD = 60000;

  public static final String
      REPLICATION_ENABLE_KEY = "bigdb.replication";
