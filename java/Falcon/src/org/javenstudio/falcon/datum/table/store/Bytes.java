 ...
 */
public class Bytes {
  private static final Logger LOG = Logger.getLogger(Bytes.class);
  ...
  public static String toString(final byte[] b, int off, int len) {
    ...
    try {
      return new String(b, off, len, DBConstants.UTF8_ENCODING);
  ...
  public static byte[] toBytes(String s) {
    try {
      return s.getBytes(DBConstants.UTF8_ENCODING);
    } catch (UnsupportedEncodingException e) {
      LOG.error("UTF-8 not supported?", e);
      return null;
    }
   ...
   * passed in array.  This method is what {@link org.javenstudio.raptor.io.Text} and
  ...
  public static byte[] add(final byte[] a, final byte[] b) {
    return add(a, b, DBConstants.EMPTY_BYTE_ARRAY);
  }
