...
public class ClassSize {
  private static final Logger LOG = Logger.getLogger(ClassSize.class);

  private static final int sNrOfRefsPerObj = 2;
  ...
  private static int [] getSizeCoefficients(Class cl, boolean debug) {
    ...
    int references = sNrOfRefsPerObj;
    ...
    if(debug) {
      if (LOG.isDebugEnabled()) {
        ...
        LOG.debug("Primitives " + coeff[0] + ", arrays " + coeff[1] +
            ", references(includes " + sNrOfRefsPerObj +
