...
public class DBObjectWritable implements Writable, Configurable {
  private static final Logger LOG = Logger.getLogger(DBObjectWritable.class);
  ...
  public Object get() { return mInstance; }

  /** @return the class this is meant to be. */
  public Class<?> getDeclaredClass() { return mDeclaredClass; }
  ...
  public void set(Object instance) {
    this.mDeclaredClass = instance.getClass();
    this.mInstance = instance;
  }
  ...
  public String toString() {
    return "OW[class=" + mDeclaredClass + ",value=" + mInstance + "]";
  }

  @Override
  public void readFields(DataInput in) throws IOException {
    readObject(in, this, this.mConf);
  }

  @Override
  public void write(DataOutput out) throws IOException {
    writeObject(out, mInstance, mDeclaredClass, mConf);
  }
  ...
  private static class NullInstance extends Configured implements Writable {
    ...
    @Override
    public void readFields(DataInput in) throws IOException {
      this.mDeclaredClass = CODE_TO_CLASS.get(in.readByte());
    }

    @Override
    public void write(DataOutput out) throws IOException {
      writeClassCode(out, this.mDeclaredClass);
    }
  }
  ...
  public static Object readObject(DataInput in,
    ...
    if (declaredClass.isPrimitive()) {            // primitive types
      ...
      if (instanceClass == NullInstance.class) {  // null
        declaredClass = ((NullInstance)instance).mDeclaredClass;
        instance = null;
      }
    }
    if (objectWritable != null) {                 // store values
      objectWritable.mDeclaredClass = declaredClass;
      objectWritable.mInstance = instance;
    }
    return instance;
  }
