...
public class Hex /*implements BinaryEncoder, BinaryDecoder*/ {
     ...
     * @since 1.7
     */
    public static final Charset DEFAULT_CHARSET = Charset.forName("UTF-8"); //Charsets.UTF_8;
     ...
     * @since 1.4
     */
    public static final String DEFAULT_CHARSET_NAME = "UTF-8"; //CharEncoding.UTF_8;
    ...
    public Object decode(final Object object) throws DecoderException {
        try {
            final char[] charArray = object instanceof String ? 
            		((String) object).toCharArray() : (char[]) object;
    ...
    public String toString() {
        return super.toString() + "[charsetName=" + this.mCharset + "]";
    }
}
