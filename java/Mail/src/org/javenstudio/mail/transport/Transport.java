...
public interface Transport {
	...
	public static interface SocketFactory { 
		public Socket createTransportSocket() throws IOException;
		public Socket createTransportSocket(Socket k, String host, int port, boolean autoClose) throws IOException;
	}
