...
public class FetchProfile extends ArrayList<Object> {
    ...
    public interface Attachment { 
    	 ...
    	 * @return the value of Content-Type header
    	 */
    	public String getContentType(); 
    	
    	/**
    	 * The value of Content-Transfer-Encoding header
    	 * @return the value of Content-Transfer-Encoding header
    	 */
    	 ...
    	 * @return the value of part location
    	 */
    	public String getLocation(); 
    	
    	/**
    	 * The output body for download attachment
    	 * @return the output body for download attachment
    	 */
    	public OutputBody getOutputBody(); 
    }
}