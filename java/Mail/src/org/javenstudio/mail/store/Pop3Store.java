...
public class Pop3Store extends Store {
    ...
    private HashMap<String, Pop3Folder> mFolders = new HashMap<String, Pop3Folder>();
...
//    private int mThroughputKbS = Integer.MAX_VALUE;
    ...
    public static Store newInstance(String uri, PersistentDataCallbacks callbacks)
    	...
    	try { 
    		...
    		LOG.error("Pop3Store.newInstance(\""+uri+"\") error", e); 
    		throw e; 
    	}
    }
     ...
     * @param uriString
     */
    protected Pop3Store(String uriString) throws MessagingException {
    	if (LOG.isDebugEnabled()) 
    		LOG.debug("new Pop3Store with "+uriString); 
    ...
    public boolean supportCapabilities() { 
    	return false;
    }
    ...
    public boolean supportMessageFlag(Flag flag) { 
    	return flag != null && flag == Flag.DELETED;
    }
    ...
    public void closeFolders(boolean expunge) throws MessagingException { 
    	synchronized (mFolders) { 
    		for (Pop3Folder folder : mFolders.values()) { 
    			if (folder.isOpen()) 
    ...
    public Folder[] getPersonalNamespaces() throws MessagingException {
        return new Folder[] {
            getFolder(MailboxData.NAME_INBOX),
        };
    }
    ...
    public void checkSettings() throws MessagingException {
        Pop3Folder folder = new Pop3Folder(MailboxData.NAME_INBOX);
        try {
    ...
    protected class Pop3Folder extends Folder {
        ...
        public Pop3Folder(String name) {
            this.mName = name;
            if (mName.equalsIgnoreCase(MailboxData.NAME_INBOX)) 
                mName = MailboxData.NAME_INBOX;
        }
        ...
        public synchronized void open(OpenMode mode, PersistentDataCallbacks callbacks)
            ...
            if (statException != null) {
                mTransport.close();
                if (LOG.isDebugEnabled()) {
                    LOG.debug(statException.toString(), statException);
                }
        ...
        public boolean exists() throws MessagingException {
            return mName.equalsIgnoreCase(MailboxData.NAME_INBOX);
        }
        ...
        public Message getMessage(String uid) throws MessagingException {
            if (mUidToMsgNumMap.size() == 0) {
                try {
                    ...
                    mTransport.close();
                    if (LOG.isDebugEnabled()) {
                        LOG.debug("Unable to index during getMessage " + ioe, ioe);
                    }
                    throw new MessagingException("getMessages error", ioe);
                }
            }
         ...
         * @throws IOException
         */
        protected void indexMsgNums(int start, int end)
        ...
        protected void indexUids(ArrayList<String> uids)
                throws MessagingException, IOException {
        ...
        protected void indexMessage(int msgNum, Pop3Message message) {
        ...
        public void fetch(Message[] messages, FetchProfile fp, MessageRetrievalListener listener)
            ...
            try {
                ...
                throw new MessagingException("fetch error", ioe);
            }
                ...
                try {
                    ...
                    if (fp.contains(FetchProfile.Item.BODY)) {
                        ...
                        fetchBody(pop3Message,
                                Preference.getPreference().getBodySaneMaxLines());
                    }
        ...
        protected void fetchEnvelope(Message[] messages,
         ...
         * @param lines
         */
        protected void fetchBody(Pop3Message message, int lines)
        ...
        public void setFlags(Message[] messages, Flag[] flags, boolean value)
            ...
            try {
                ...
                throw new MessagingException("setFlags error", ioe);
            }
        }
...
//        }
        ...
        protected Pop3Capabilities getCapabilities() throws IOException, MessagingException {
    ...
    protected class Pop3Message extends MimeMessage {
     ...
     */
    protected class Pop3Capabilities {
    ...
    protected class Pop3ResponseInputStream extends InputStream {
        InputStream mIn;
