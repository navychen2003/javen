...
public final class SimpleSocket extends Socket implements SocketMetrics.SocketInfo {
	...
	public SimpleSocket(String dstName, int dstPort) throws UnknownHostException, IOException {
		super(dstName, dstPort); 
		mMetrics = new SocketMetrics(this); 
	}
	
	public SimpleSocket(String dstName, int dstPort, InetAddress localAddress, int localPort) throws IOException {
		super(dstName, dstPort, localAddress, localPort); 
		mMetrics = new SocketMetrics(this); 
	}
	
	@Deprecated
    public SimpleSocket(String hostName, int port, boolean streaming) throws IOException {
	...
	public SimpleSocket(InetAddress dstAddress, int dstPort, InetAddress localAddress, int localPort) throws IOException {
		super(dstAddress, dstPort, localAddress, localPort); 
		mMetrics = new SocketMetrics(this); 
	}
	
	@Deprecated
    public SimpleSocket(InetAddress addr, int port, boolean streaming) throws IOException {
