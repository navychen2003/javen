...
public class ToolBarHelper {
	...
	protected void setChildViewChecked(ToolBar.OnCheckListener listener, View view, Object ignore, boolean checked) { 
    ...
    public void setChildChecked(ToolBar.CheckedButton button, ToolBar.OnCheckListener listener, boolean radio) {
    ...
    public ImageButton addImageButton(int resid, int imageid, int backgroundid) {
    	...
    	Drawable background = backgroundid != 0 ? ResourceHelper.getResourceContext().getDrawable(backgroundid) : null; 
    ...
    public InputButton addInputButton(int resid, int textid, int backgroundid, TextWatcher watcher) {
    	...
    	if (backgroundid != 0) 
    		button.setBackgroundDrawable(ResourceHelper.getResourceContext().getDrawable(backgroundid)); 
    ...
    private TextButton addImageTextButton(int resid, Drawable image, CharSequence text, int backgroundid, int position) {
    	if (resid == 0) return null; 
