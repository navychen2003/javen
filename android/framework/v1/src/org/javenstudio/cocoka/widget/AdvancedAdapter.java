...
public class AdvancedAdapter extends BaseAdapter implements Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
    	final int resource = getResource(position); 
    	
        View view = null; 
        if (view == null) {
        	view = createViewFromResource(position, convertView, parent, resource);
        } 
    ...
    private void bindView(DataSet dataSet, int position, View view) {
        ...
        if (binder != null) {
            binder.onViewBinded(dataSet, view);
        }
    }
    ...
    public static interface ViewBinder {
    	...
    	public void onViewBinded(DataSet dataSet, View view); 
    }
