...
public final class Scheduler {
	...
	public final void post(final Work work) throws InterruptedException, WorkException {
		if (work == null) 
	...
	public final void post(final Workflow flow) throws InterruptedException, WorkException {
		if (flow == null) 
	...
	private final void postAtTimeOrDelayed(final Work work, long uptimeMillis, long delayMillis) 
	...
	private final void postAtTimeOrDelayed(final Workflow flow, long uptimeMillis, long delayMillis) 
			throws InterruptedException, WorkException {
		if (flow == null) 
			throw new NullPointerException("workflow is null"); 
