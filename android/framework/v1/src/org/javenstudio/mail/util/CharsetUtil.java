...
public class CharsetUtil {
    ...
    private static class Charset implements Comparable<Object> {
    ...
    private static Charset[] JAVA_CHARSETS = {
        ...
        new Charset("GB2312", "GB2312", new String[] {"EUC_CN", "x-EUC-CN", "csGB2312", "euccn", "euc-cn", "gb2312-80", "gb2312-1980", "CN-GB", "CN-GB-ISOIR165"}),
        new Charset("GBK", "GBK", new String[] {"windows-936", "CP936", "MS936", "ms_936", "x-mswin-936"}),
    ...
    static {
        ...
        for (int i = 0; i < JAVA_CHARSETS.length; i++) {
        	Charset charset = JAVA_CHARSETS[i]; 
            try {
                String s = new String(dummy, charset.canonical);
                decodingSupported.add(charset.canonical.toLowerCase());
            } catch (UnsupportedOperationException e) {
            	if (LOG.isDebugEnabled()) 
            		LOG.warn("CharsetUtil: unsupported operation: " + charset.canonical + ": " + e); 
            } catch (UnsupportedEncodingException e) {
            	if (LOG.isDebugEnabled()) 
            		LOG.warn("CharsetUtil: unsupported encoding: " + charset.canonical + ": " + e); 
            }
            try {
    ...
    public static final java.nio.charset.Charset GBK = java.nio.charset.Charset
            .forName("GBK");
