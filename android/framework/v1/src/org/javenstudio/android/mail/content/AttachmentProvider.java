...
import org.javenstudio.cocoka.storage.content.StorageProvider;
...
public abstract class AttachmentProvider implements StorageProvider {
	...
	protected abstract class AttachmentStore extends MediaCenter { 
		...
		protected abstract AttachmentFile saveAttachmentFile(
				String emailAddress, InputStream in, String filename, String contentUri) throws IOException; 
	}
	...
	protected class AttachmentStoreFile implements AttachmentFile { 
		...
		public AttachmentStoreFile(AttachmentStore store, StorageFile file, String contentUri) { 
			mStore = store; 
			mFile = file; 
	...
	public synchronized AttachmentFile openAttachmentFile(AttachmentContent attachment) throws MessagingException { 
		if (attachment != null) { 
	...
	protected AttachmentFile openLocalAttachmentFile(AttachmentContent attachment, String filepath) throws IOException { 
	...
	public synchronized AttachmentFile saveAttachmentFile(MessageContent localMessage, Body body) 
	...
	protected AttachmentFile doSaveAttachmentFile(MessageContent localMessage, Body body) 
