...
public abstract class JsonHandler {
	...
	protected synchronized final void handleNodeBegin(String name) { 
		if (name == null) return; 
	...
	protected synchronized final void handleNodeEnd(String name) { 
		if (name == null) return; 
	...
	protected synchronized final void handleNodeValue(String name, Object value) { 
		if (name == null) return; 
