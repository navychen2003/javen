...
public class TagTree {
	...
	private static class RootTag extends Tag { 
		public RootTag(String name, String[] attrNames, String[] attrValues, Tag.AttributesMatcher matcher) { 
	...
	TagTree(Callbacks callbacks, String rootTag, String[] attrNames, String[] attrValues, Tag.AttributesMatcher matcher) {
	...
	private synchronized void addTag(Tag tag) throws ParseException { 
		if (tag == null) return; 
	...
	public synchronized void resetMatching() { 
		mNext = mRoot; 
	}
	...
	public synchronized void onStartTag(String name, Tag.IAttributes attributes) { 
	...
	public synchronized void onEndTag(String name) { 
		// do nothing
	}
