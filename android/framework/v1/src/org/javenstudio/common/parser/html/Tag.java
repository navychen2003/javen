...
public class Tag {
	...
	Tag(Tag parent, String name, String[] attrNames, String[] attrValues, AttributesMatcher matcher) { 
		mParent = parent; 
	...
	private final Tag newChild(String name, String[] attrNames, String[] attrValues, AttributesMatcher matcher) { 
	...
	public synchronized Tag nextTag() { 
