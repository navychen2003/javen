...
public class HTMLHandler implements TagHandler {
	...
	public synchronized final Tag newSubContentBeginTag(String name, String[] attrNames, String[] attrValues) { 
		return mTraveller.newBeginTree(name, attrNames, attrValues, null).getRootTag(); 
	}
	
	public synchronized final Tag newSubContentBeginTag(String name, Tag.AttributesMatcher matcher) { 
	...
	public synchronized final Tag newSubContentEndTag(String name, String[] attrNames, String[] attrValues) { 
		return mTraveller.newEndTree(name, attrNames, attrValues, null).getRootTag(); 
	}
	
	public synchronized final Tag newSubContentEndTag(String name, Tag.AttributesMatcher matcher) { 
		return mTraveller.newEndTree(name, null, null, matcher).getRootTag(); 
	}
	
	public synchronized final Tag newSubContentTag(String name) { 
		return newSubContentTag(name, null, null); 
	}
	
	public synchronized final Tag newSubContentTag(String name, String[] attrNames, String[] attrValues) { 
		return mTraveller.newContentTree(name, attrNames, attrValues, null).getRootTag(); 
	}
	
	public synchronized final Tag newSubContentTag(String name, Tag.AttributesMatcher matcher) { 
		return mTraveller.newContentTree(name, null, null, matcher).getRootTag(); 
	}
	
	@Override 
	public synchronized void handleStartDocument() throws SAXException { 
		try { 
			mTraveller.init(); 
	...
	@Override 
	public synchronized void handleEndDocument() { 
	...
	@Override 
	public synchronized void handleStartTag(String localName, String qName, Attributes attributes) { 
	...
	@Override 
	public synchronized void handleEndTag(String localName, String qName) { 
	...
	protected synchronized void onContentTreeFound() { 
