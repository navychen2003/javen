...
public final class ResourceContextHelper {
		...
		return new ResourceContext() { 
				...
				public BitmapRef decodeBitmap(int resId) { 
					if (decodeBitmapByIdMethod != null) { 
						return BitmapRef.newBitmap(manager, 
								invokeStaticMethod(decodeBitmapByIdMethod, getPackageContext(), resId)); 
					} else if (decodeBitmapByNameMethod != null) { 
						String name = ResourceMap.getResourceName(ResourceMap.DRAWABLE, resId); 
						if (name != null) {
							return BitmapRef.newBitmap(manager, 
									invokeStaticMethod(decodeBitmapByNameMethod, getPackageContext(), name)); 
						}
					}
					return null;
				}
	...
	static ResourceContext createModuleResourceContext(final ResourceManager manager) { 
		return new ResourceContext() {
				@Override
				...
				public BitmapRef decodeBitmap(int resId) {
					return BitmapRef.newBitmap(manager, 
							ModuleMethods.invokeMainMethod("decodeBitmap", resId));
				}
