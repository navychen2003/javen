...
public class DelegatedBitmapDrawable extends BaseDrawable 
		implements Recycleable, Delegatable {
	//private static final Logger LOG = Logger.getLogger(DelegatedBitmapDrawable.class);
    ...
    public void setBounds(int left, int top, int right, int bottom) {
    	...
    	//	LOG.debug("setBounds: id=" + getIdentity() + " bounds=" + mBounds);
    ...
    public void draw(Canvas canvas) {
    	...
    	if (mBitmap != null) {
    		//if (LOG.isDebugEnabled())
        	//	LOG.debug("draw: id=" + getIdentity() + " bitmap=" + mBitmap + " bounds=" + mBounds);
