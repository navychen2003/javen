package org.javenstudio.cocoka.net.http.multipart;
...
public class MultipartEntity extends AbstractHttpEntity {
    ...
    private static final Logger LOG = Logger.getLogger(MultipartEntity.class);
    ...
    */
    ...
    public Header getContentType() {
      Header header = super.getContentType();
      String contentType = header != null ? header.getValue() : null;
      if (contentType == null || contentType.length() == 0) 
    	  contentType = MULTIPART_FORM_CONTENT_TYPE;
    ...
    public long getContentLength() {
        try {
        	...
        	if (LOG.isWarnEnabled())
        		LOG.warn("An exception occurred while getting the length of the parts", e);
            return 0;
        }
    }    
