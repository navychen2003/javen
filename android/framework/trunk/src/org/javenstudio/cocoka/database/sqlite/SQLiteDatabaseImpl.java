...
public class SQLiteDatabaseImpl implements Database {
	...
	public void createTable(DBTable<? extends IIdentity, ? extends IEntity<?>> entityTable) 
			throws SQLException {
		if (!(entityTable instanceof SQLiteTable)) 
			throw new DBException("Entity DBTable isn't a SQLiteTable instance");
		
		final SQLiteTable<? extends IEntity<?>> table = 
				(SQLiteTable<? extends IEntity<?>>)entityTable;
