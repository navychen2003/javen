...
public class ExpandableAdapter extends BaseExpandableListAdapter { 
	private static final Logger LOG = Logger.getLogger(ExpandableAdapter.class);
	...
	private int getGroupResource(GroupDataSet dataSet, int groupPosition, boolean isExpanded) {
	...
	private int getChildResource(ChildDataSet dataSet, int groupPosition, 
	...
	private View createViewFromResource(DataSet dataSet, View convertView,
			...
			if (view != null && convertView == null) { 
				...
				if (LOG.isDebugEnabled()) {
					LOG.debug("createViewFromResource: use binded view," 
							+ " dataSet=" + dataSet + " convertView=" + view);
				}
			}
		}
        ...
        if (LOG.isDebugEnabled()) { 
        	LOG.debug("createViewFromResource: view=" + v 
        			+ " convertView=" + convertView + " resource=" + resource
        			+ " dataSet=" + dataSet);
        }
	...
	private void bindView(final DataSet dataSet, final View view, 
			final String[] from, final int[] to, int stat) {
