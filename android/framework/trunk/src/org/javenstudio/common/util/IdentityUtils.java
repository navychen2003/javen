...
public class IdentityUtils {
	...
	public static String newKey(String name, int len) { 
		return IdentityUtils.toIdentity(IdentityUtils.toKeyString(name), len);
	}
	
	public static String newChecksumKey(String name, int len) { 
    ...
    // 16 chars
    public static String toKeyString(String val) {
		try {
			if (val != null) {
			...
			else throw new RuntimeException(e.toString(), e);
		}
