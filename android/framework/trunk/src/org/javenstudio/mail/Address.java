...
import org.javenstudio.mail.util.Rfc822Token;
import org.javenstudio.mail.util.Rfc822Tokenizer;
...
public class Address {
    ...
    public void setPersonal(String personal) {
        if (personal != null) {
            ...
            personal = StringUtils.trim(DecoderUtil.decodeEncodedWords(personal));
    ...
    public static boolean isAllValid(String addressList) {
        ...
        if (addressList != null && addressList.length() > 0) {
            ...
            for (int i = 0, length = tokens.length; i < length; ++i) {
                ...
                if (!StringUtils.isEmpty(address) && !isValidAddress(address)) {
                    return false;
                }
            }
        }
    ...
    public static String pack(String... addresses) { 
    	if (addresses == null) 
            return null;
