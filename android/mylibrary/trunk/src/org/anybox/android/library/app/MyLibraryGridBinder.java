...
import org.javenstudio.provider.app.anybox.library.AnyboxLibraryGridBinder;
...
public class MyLibraryGridBinder extends AnyboxLibraryGridBinder {
	//private static final Logger LOG = Logger.getLogger(MyLibraryGridBinder.class);

	private final MyBinderHelper mHelper = MyBinderHelper.YELLOW;
	
	public MyLibraryGridBinder(AnyboxLibraryProvider provider, 
	...
	public void addItemView(IActivity activity, DataBinderItem item, 
		...
		super.addItemView(activity, item, container, view, index, count);
	}
