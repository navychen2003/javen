...
public abstract class SelectListItem extends DataBinderItem 
		implements ImageListener {
	private static final Logger LOG = Logger.getLogger(SelectListItem.class);
	...
	public static interface ImageFetchListener { 
		public void onImageFetched(SelectListItem item, Image image);
	}
	
	private final SelectOperation mOperation;
	private final SelectFolderItem mParent;
	...
	public SelectListItem(SelectOperation op, SelectFolderItem parent) {
		if (op == null) throw new NullPointerException();
		mOperation = op;
		mParent = parent;
	}
	
	public SelectOperation getOperation() { return mOperation; }
	public SelectFolderItem getParent() { return mParent; }
	public abstract ISelectData getData();
	
	public abstract int getViewRes();
	public abstract void bindView(Activity activity, ISelectCallback callback, View view);
	...
	public void onItemClick(Activity activity, ISelectCallback callback) {}
