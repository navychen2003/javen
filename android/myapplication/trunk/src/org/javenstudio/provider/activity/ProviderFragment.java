...
public class ProviderFragment extends ContentFragment {
	private static final Logger LOG = Logger.getLogger(ProviderFragment.class);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ProviderActivity activity = getProviderActivity();
