...
public class AccountDetailsTab extends AccountActionTab {
	private static final Logger LOG = Logger.getLogger(AccountDetailsTab.class);
	...
	public AccountDetailsTab(AccountInfoItem item, String name) { 
		this(item, name, 0);
	}
	
	public AccountDetailsTab(AccountInfoItem item, String name, int iconRes) { 
