...
public class OverviewUsedItem extends SpaceItem {

	private final ITotalSpaceData mData;
	
	public OverviewUsedItem(OverviewUsedProvider provider, 
	...
	public int getViewRes() {
		return R.layout.storagespace_used;
	}
	...
	public void bindView(View view) {
		...
		final TextView titleView = (TextView)view.findViewById(R.id.overviewused_item_title);
		if (titleView != null) {
			String text = AppResources.getInstance().getResources().getString(R.string.total_used_space_title);
		...
		final TextView subtitleView = (TextView)view.findViewById(R.id.overviewused_item_subtitle);
		...
		final ImageView percentView = (ImageView)view.findViewById(R.id.overviewused_item_percent);
		if (percentView != null) {
