...
public class GroupDetails extends GroupAction {
	private static final Logger LOG = Logger.getLogger(GroupDetails.class);
	...
	public GroupDetails(GroupItem item, String name) { 
		this(item, name, 0);
	}
	
	public GroupDetails(GroupItem item, String name, int iconRes) { 
