...
public class UserDetailsProfile implements UserDetails.DetailsItem {
	...
	public CharSequence getTitle() { 
		return ResourceHelper.getResources().getString(R.string.accountinfo_details_basic_title); 
	}
	...
	public View getView(Context context, View convertView, boolean dropDown) { 
		...
		if (convertView == null || convertView.getId() != R.layout.user_profile) 
			convertView = inflater.inflate(R.layout.user_profile, null);
		
		TextView title = (TextView)convertView.findViewById(R.id.user_profile_title);
		title.setText(getTitle());
		
		ViewGroup itemsRoot = (ViewGroup)convertView.findViewById(R.id.user_profile_items);
		...
		synchronized (mItems) { 
			for (ProfileItem item : mItems) { 
				...
				View itemView = inflater.inflate(R.layout.user_profile_item, itemsRoot, false);
				
				TextView itemName = (TextView)itemView.findViewById(R.id.user_profile_item_name);
				TextView itemValue = (TextView)itemView.findViewById(R.id.user_profile_item_value);
