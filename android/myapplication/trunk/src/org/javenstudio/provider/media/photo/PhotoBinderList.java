...
public abstract class PhotoBinderList extends PhotoBinder {
	...
	protected int getPhotoItemViewRes() { return R.layout.photo_item_list; }
	protected int getPhotoItemHeaderViewId() { return R.id.photo_item_thumbnail; }
	protected int getPhotoItemHeaderHeightId() { return R.dimen.photo_item_header_height; }
	protected int getPhotoItemImageViewId() { return R.id.photo_item_thumbnail; }
	...
	protected void setImageViewSize(IActivity activity, PhotoItem item, View view) { 
		int thumbWidth = (int)activity.getResources().getDimension(R.dimen.photo_item_listthumb_width);
		int thumbHeight = (int)activity.getResources().getDimension(R.dimen.photo_item_listthumb_height);
