...
import org.javenstudio.provider.media.album.AlbumBinderList;
...
public class MediaAlbumBinderList extends AlbumBinderList {

	private final MediaAlbumSource mSource;
	
	public MediaAlbumBinderList(MediaAlbumSource source) { 
		mSource = source;
	}
