...
import org.javenstudio.provider.media.MediaPhotoBinderSmall;
import org.javenstudio.provider.media.MediaPhotoSource;
import org.javenstudio.provider.media.photo.PhotoItem;

final class FlickrPhotoBinderSmall extends MediaPhotoBinderSmall {

	public FlickrPhotoBinderSmall(MediaPhotoSource source) { 
		super(source);
	}
