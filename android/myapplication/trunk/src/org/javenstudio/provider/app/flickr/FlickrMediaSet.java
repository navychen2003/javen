...
public abstract class FlickrMediaSet extends MediaSet 
		implements MediaInfo, PhotoSet, AlbumSet {

	private FlickrUserClickListener mUserClickListener = null;
	private boolean mDirty = false;
	
	public FlickrMediaSet(DataPath path, long version) { 
		super(path, version);
	}
    ...
    public void setUserClickListener(FlickrUserClickListener listener) { 
    	mUserClickListener = listener;
    }
    
    public FlickrUserClickListener getUserClickListener() { 
