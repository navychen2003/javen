...
import org.javenstudio.provider.media.MediaAlbumBinderSmall;
import org.javenstudio.provider.media.MediaAlbumSource;

final class FlickrAlbumBinderSmall extends MediaAlbumBinderSmall {

	public FlickrAlbumBinderSmall(MediaAlbumSource source) { 
		super(source);
	}
