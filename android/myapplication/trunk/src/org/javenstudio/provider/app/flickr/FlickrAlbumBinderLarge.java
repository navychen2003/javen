...
import org.javenstudio.provider.media.MediaAlbumBinderLarge;
import org.javenstudio.provider.media.MediaAlbumSource;

final class FlickrAlbumBinderLarge extends MediaAlbumBinderLarge {

	public FlickrAlbumBinderLarge(MediaAlbumSource source) { 
		super(source);
	}
