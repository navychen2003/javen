...
public class FileAudioInfo extends FileInfo {
	//private static Logger LOG = Logger.getLogger(FileAudioInfo.class);
	...
	public FileAudioInfo(String filepath) { 
		if (filepath == null) throw new NullPointerException();
		mLocation = filepath; 
		mFile = new File(filepath);
		mPath = DataPath.fromString("/local/audio/item/" + Utilities.toMD5(filepath));
