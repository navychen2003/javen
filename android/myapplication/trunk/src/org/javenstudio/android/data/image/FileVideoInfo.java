...
public class FileVideoInfo extends FileInfo {
	//private static Logger LOG = Logger.getLogger(FileVideoInfo.class);
	...
	public FileVideoInfo(String filepath) { 
		if (filepath == null) throw new NullPointerException();
		mLocation = filepath; 
		mFile = new File(filepath);
		mPath = DataPath.fromString("/local/video/item/" + Utilities.toMD5(filepath));
