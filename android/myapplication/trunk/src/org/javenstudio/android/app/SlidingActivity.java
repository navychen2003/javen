...
import org.javenstudio.cocoka.app.SlidingMenuActivity;
...
public abstract class SlidingActivity extends SlidingMenuActivity 
		implements IActivity {
	private static final Logger LOG = Logger.getLogger(SlidingActivity.class);
	...
	protected final ActivityHelper createActivityHelper() { 
		return new ActivityHelper(this) { 
				...
				protected boolean isLockOrientationDisabled(int orientation) { 
					return SlidingActivity.this.isLockOrientationDisabled(orientation); 
				}
				protected boolean isUnlockOrientationDisabled() { 
					return SlidingActivity.this.isUnlockOrientationDisabled(); 
				}
			};
	}
    ...
    public void onBackPressed() {
        ...
        if (showMenuOnHide()) return;
		super.onBackPressed(); 
	}
	
	protected boolean showMenuOnHide() { 
	...
	protected Fragment createSecondaryMenuFragment() { 
		return new SlidingSecondaryFragment();
	}
