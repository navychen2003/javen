...
public class TiledTexture implements Texture {
    ...
    private static BitmapRef sUploadBitmap;
    ...
    private static class Tile extends UploadedTexture {
        ...
        public Tile(BitmapHolder holder) { 
        	super(holder);
        }
        ...
        protected BitmapRef onGetBitmap() {
            ...
            sCanvas.drawBitmap(bitmap.get(), x, y, sBitmapPaint);
            bitmap = null;
    ...
    private static Tile obtainTile(BitmapHolder holder) {
        synchronized (sFreeTileLock) {
            Tile result = sFreeTileHead;
            if (result == null) return new Tile(holder);
    ...
    public TiledTexture(BitmapHolder holder, BitmapRef bitmap) {
    	mHolder = holder;
    ...
    public static void prepareResources(BitmapHolder holder) {
        sUploadBitmap = BitmapRef.createBitmap(holder, TILE_SIZE, TILE_SIZE);
        sCanvas = new Canvas(sUploadBitmap.get());
