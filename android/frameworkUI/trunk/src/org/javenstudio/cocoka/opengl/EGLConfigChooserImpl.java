 ...
 */
class EGLConfigChooserImpl implements EGLConfigChooser {
    private static final Logger LOG = Logger.getLogger(EGLConfigChooserImpl.class);
    ...
    private void logConfig(EGL10 egl, EGLDisplay display, EGLConfig config) {
        ...
        if (LOG.isDebugEnabled())
        	LOG.debug("Config chosen: " + sb.toString());
    }
