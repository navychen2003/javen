...
public class EdgeEffect {
    ...
    private final EdgeDrawable mEdge;
    private final EdgeDrawable mGlow;
    private int mWidth;
	private int mHeight;
     ...
     */
    public EdgeEffect(Context context, BitmapHolder holder, int edgeRes, int glowRes) {
        mEdge = new EdgeDrawable(context, holder, edgeRes); //R.drawable.overscroll_edge);
        mGlow = new EdgeDrawable(context, holder, glowRes); //R.drawable.overscroll_glow);
    ...
    private static class EdgeDrawable extends ResourceTexture {
        private Rect mBounds = new Rect();
        private int mAlpha = 255;

        public EdgeDrawable(Context context, BitmapHolder holder, int resId) {
            super(context, holder, resId);
        }
