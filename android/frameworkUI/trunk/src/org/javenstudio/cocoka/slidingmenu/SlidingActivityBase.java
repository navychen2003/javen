...
public interface SlidingActivityBase {
	 ...
	 */
	public void setMenuContentView(View view, LayoutParams layoutParams);
	 ...
	 * default to MATCH_PARENT. To use your
	...
	/**
	 * Set the behind view content from a layout resource. 
	 * The resource will be inflated, adding all top-level views
	 * to the behind view.
	 *
	 * @param layoutResID Resource ID to be inflated.
	 */
	public void setMenuContentView(int layoutResID);
