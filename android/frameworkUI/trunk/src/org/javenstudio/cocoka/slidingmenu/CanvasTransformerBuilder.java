...
public class CanvasTransformerBuilder {
	...
	private void initTransformer() {
		if (mTrans == null)
			...
			public void transformCanvas(SlidingMenuViews views, Canvas canvas, int type, float percentOpen) {}
		};
	}
	...
	public SlidingMenu.CanvasTransformer zoom(final int openedX, final int closedX, 
		...
		mTrans = new SlidingMenu.CanvasTransformer() {
			public void transformCanvas(SlidingMenuViews views, Canvas canvas, int type, float percentOpen) {
				mTrans.transformCanvas(views, canvas, type, percentOpen);
	...
	public SlidingMenu.CanvasTransformer concatTransformer(final SlidingMenu.CanvasTransformer t) {
		...
		mTrans = new SlidingMenu.CanvasTransformer() {
			public void transformCanvas(SlidingMenuViews views, Canvas canvas, int type, float percentOpen) {
				mTrans.transformCanvas(views, canvas, type, percentOpen);
				t.transformCanvas(views, canvas, type, percentOpen);
			}			
		};
		return mTrans;
	}
