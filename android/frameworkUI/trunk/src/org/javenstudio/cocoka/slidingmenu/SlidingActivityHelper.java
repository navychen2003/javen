...
public class SlidingActivityHelper {
	...
	private View mViewMenuSecondary;
	 ...
	 * Should be called within the activitiy's onCreate()
	 *
	...
	/**
	 * Further SlidingMenu initialization. 
	 * Should be called within the activitiy's onPostCreate()
	 *
	 * @param savedInstanceState the saved instance state (unused)
	 */
	public void onPostCreate(Bundle savedInstanceState) {
		if (mViewMenu == null || mViewContent == null) {
	 ...
	 *
	 * @param slidingActionBarEnabled True if you want the ActionBar to 
	 * slide along with the SlidingMenu,
	 ...
	 * killed so that the state can be
	 * restored in onCreate(Bundle) or onRestoreInstanceState(Bundle) 
	 * (the Bundle populated by this method
	 ...
	 * This view is placed directly into the activity's view
	 * hierarchy. It can itself be a complex view hierarchy. 
	 * When calling this method, the layout parameters
	 * of the specified view are ignored. Both the width and 
	 * the height of the view are set by default to
	 * MATCH_PARENT. To use your own layout parameters, 
	 * invoke setContentView(android.view.View,
	 ...
	 */
	public void setMenuView(View view, LayoutParams layoutParams) {
		mViewMenu = view;
		mSlidingMenu.setMenu(mViewMenu, layoutParams);
	}
	
	public void setSecondaryMenuView(View view, LayoutParams layoutParams) {
		mViewMenuSecondary = view;
		mSlidingMenu.setSecondaryMenu(mViewMenuSecondary, layoutParams);
	}
