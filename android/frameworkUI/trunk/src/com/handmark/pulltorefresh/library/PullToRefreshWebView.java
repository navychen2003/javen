...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
	...
	private static final OnRefreshListener<WebView> defaultOnRefreshListener = new OnRefreshListener<WebView>() {
		...
		@Override
		public void onRefresh(PullToRefreshBase<WebView> refreshView, boolean... params) {
			refreshView.getRefreshableView().reload();
		}

		@Override
		public void onDispatchTouchEvent(PullToRefreshBase<WebView> refreshView, MotionEvent event) {
		}
