...
public class CustomViewMenu extends ViewGroup {
	private static final String TAG = "CustomViewMenu";
	...
	protected void dispatchDraw(Canvas canvas) {
		if (mTransformer != null) {
			canvas.save();
			mTransformer.transformCanvas(canvas, mViewContent.getPercentOpen());
