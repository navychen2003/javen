...
public class ActionBarWrapper extends ActionBar implements 
		android.app.ActionBar.OnNavigationListener, android.app.ActionBar.OnMenuVisibilityListener {
	private static final Logger LOG = Logger.getLogger(ActionBarWrapper.class);
